...
export const metadata: Metadata = {
  title: 'Millimeters to Micrometers Converter',
  description: 'millimeters to micrometers converter. Convert mm to μm instantly with accurate results. Perfect for precision engineering, manufacturing, and scientific measurements.',
  openGraph: {
    title: 'Millimeters to Micrometers Converter',
    description: 'millimeters to micrometers converter. Convert mm to μm instantly with accurate results. Perfect for precision engineering, manufacturing, and scientific measurements.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Millimeters to Micrometers Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            millimeters to micrometers converter. Convert mm to μm instantly with accurate results. Perfect for precision engineering, manufacturing, and scientific measurements.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="mm" defaultTo="micrometers" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mm to Micrometers conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mm to Micrometers</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mm as input and Micrometers as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mm to Micrometers conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mm to Micrometers?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mm, select Mm as input and Micrometers as output, then click convert.</p>
            </div>
            <div className="card p-6">
