...
export const metadata: Metadata = {
  title: 'Hectometers to Millimeters Converter',
  description: 'hectometers to millimeters converter. Convert hm to mm instantly with accurate results.',
  openGraph: {
    title: 'Hectometers to Millimeters Converter',
    description: 'hectometers to millimeters converter. Convert hm to mm instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Hectometers to Millimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            hectometers to millimeters converter. Convert hm to mm instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="hm" defaultTo="mm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Hm to Mm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 hm = 50000000 mm</li>
                <li>1000 hm = 100000000 mm</li>
                <li>5000 hm = 500000000 mm</li>
                <li>10000 hm = 1000000000 mm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Hm to Mm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Hm as input and Mm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Hm to Mm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Hm to Mm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Hm, select Hm as input and Mm as output, then click convert.</p>
            </div>
            <div className="card p-6">
