...
export const metadata: Metadata = {
  title: 'Square Kilometers to Square Centimeters Converter',
  description: 'square kilometers to square centimeters converter. Convert km² to cm² instantly with accurate results.',
  openGraph: {
    title: 'Square Kilometers to Square Centimeters Converter',
    description: 'square kilometers to square centimeters converter. Convert km² to cm² instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Kilometers to Square Centimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square kilometers to square centimeters converter. Convert km² to cm² instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="area" defaultFrom="km2" defaultTo="cm2" />
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 km² = 5000000000000 cm²</li>
                <li>1000 km² = 10000000000000 cm²</li>
                <li>5000 km² = 50000000000000 cm²</li>
                <li>10000 km² = 100000000000000 cm²</li>
              </ul>
            </div>
          </div>
        </section>
