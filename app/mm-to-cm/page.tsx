...
export const metadata: Metadata = {
  ...
  description: 'millimeters to centimeters converter. Convert mm to cm instantly with accurate results.',
  openGraph: {
    title: 'Millimeters to Centimeters Converter',
    description: 'millimeters to centimeters converter. Convert mm to cm instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Millimeters to Centimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            millimeters to centimeters converter. Convert mm to cm instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="mm" defaultTo="cm" />
          </div>
        </section>
