...
export const metadata: Metadata = {
  title: 'Square Feet to Hectares Converter',
  description: 'square feet to hectares converter. Convert ft² to ha instantly with accurate results.',
  openGraph: {
    title: 'Square Feet to Hectares Converter',
    description: 'square feet to hectares converter. Convert ft² to ha instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Feet to Hectares Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square feet to hectares converter. Convert ft² to ha instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="speed" defaultFrom="ft2" defaultTo="hectare" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Ft2 to Hectare conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 ft² = 0.004645 hectare</li>
                <li>1000 ft² = 0.00929 hectare</li>
                <li>5000 ft² = 0.04645 hectare</li>
                <li>10000 ft² = 0.0929 hectare</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Ft2 to Hectare</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Ft2 as input and Hectare as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Ft2 to Hectare conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Ft2 to Hectare?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Ft2, select Ft2 as input and Hectare as output, then click convert.</p>
            </div>
            <div className="card p-6">
