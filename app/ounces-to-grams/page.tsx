...
export const metadata: Metadata = {
  ...
  description: 'ounces to grams converter. Convert ounces to grams instantly. 1 ounce = 28.3495 grams. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'Ounces to Grams Converter - Convert Ounces to Grams',
    description: 'ounces to grams converter. Convert ounces to grams instantly. 1 ounce = 28.3495 grams. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Ounces to Grams Converter - Convert Ounces to Grams</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            ounces to grams converter. Convert ounces to grams instantly. 1 ounce = 28.3495 grams. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="ounces" defaultTo="grams" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Ounces to Grams conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 ounces = 14174.7615625 grams</li>
                <li>1000 ounces = 28349.523125 grams</li>
                <li>5000 ounces = 141747.615625 grams</li>
                <li>10000 ounces = 283495.23125 grams</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Ounces to Grams</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Ounces as input and Grams as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Ounces to Grams conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Ounces to Grams?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Ounces, select Ounces as input and Grams as output, then click convert.</p>
            </div>
            <div className="card p-6">
