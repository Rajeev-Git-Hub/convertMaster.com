...
export const metadata: Metadata = {
  title: 'Meters to Decimeters Converter',
  description: 'meters to decimeters converter. Convert m to dm instantly with accurate results. Perfect for metric measurements.',
  openGraph: {
    title: 'Meters to Decimeters Converter',
    description: 'meters to decimeters converter. Convert m to dm instantly with accurate results. Perfect for metric measurements.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Meters to Decimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            meters to decimeters converter. Convert m to dm instantly with accurate results. Perfect for metric measurements.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="meters" defaultTo="dm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Meters to Dm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Meters to Dm</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 meters = 10 dm</li>
                <li>10 meters = 100 dm</li>
                <li>50 meters = 500 dm</li>
                <li>100 meters = 1000 dm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Dm to Meters</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 dm = 0.1 meters</li>
                <li>10 dm = 1 meters</li>
                <li>50 dm = 5 meters</li>
                <li>100 dm = 10 meters</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 meters = 5000 dm</li>
                <li>1000 meters = 10000 dm</li>
                <li>5000 meters = 50000 dm</li>
                <li>10000 meters = 100000 dm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Meters to Dm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Meters as input and Dm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Meters to Dm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Meters to Dm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Meters, select Meters as input and Dm as output, then click convert.</p>
            </div>
            <div className="card p-6">
