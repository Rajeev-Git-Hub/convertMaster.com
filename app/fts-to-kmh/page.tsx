...
export const metadata: Metadata = {
  title: 'Feet per Second to Kilometers per Hour Converter',
  description: 'feet per second to kilometers per hour converter. Convert ft/s to km/h instantly with accurate results.',
  openGraph: {
    title: 'Feet per Second to Kilometers per Hour Converter',
    description: 'feet per second to kilometers per hour converter. Convert ft/s to km/h instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Feet per Second to Kilometers per Hour Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            feet per second to kilometers per hour converter. Convert ft/s to km/h instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="fts" defaultTo="kmh" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Fts to Kmh conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 fts = 548.64 kmh</li>
                <li>1000 fts = 1097.28 kmh</li>
                <li>5000 fts = 5486.4 kmh</li>
                <li>10000 fts = 10972.8 kmh</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Fts to Kmh</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Fts as input and Kmh as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Fts to Kmh conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Fts to Kmh?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Fts, select Fts as input and Kmh as output, then click convert.</p>
            </div>
            <div className="card p-6">
