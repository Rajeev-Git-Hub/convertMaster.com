...
export const metadata: Metadata = {
  title: 'Centimeters to Decimeters Converter',
  description: 'centimeters to decimeters converter. Convert cm to dm instantly with accurate results. Perfect for metric measurements and educational purposes.',
  openGraph: {
    title: 'Centimeters to Decimeters Converter',
    description: 'centimeters to decimeters converter. Convert cm to dm instantly with accurate results. Perfect for metric measurements and educational purposes.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Centimeters to Decimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            centimeters to decimeters converter. Convert cm to dm instantly with accurate results. Perfect for metric measurements and educational purposes.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="cm" defaultTo="dm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Cm to Dm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 cm = 50 dm</li>
                <li>1000 cm = 100 dm</li>
                <li>5000 cm = 500 dm</li>
                <li>10000 cm = 1000 dm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Cm to Dm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Cm as input and Dm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Cm to Dm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Cm to Dm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Cm, select Cm as input and Dm as output, then click convert.</p>
            </div>
            <div className="card p-6">
