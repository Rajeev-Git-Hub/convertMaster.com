...
export const metadata: Metadata = {
  title: 'Miles per Hour to Feet per Second Converter',
  description: 'miles per hour to feet per second converter. Convert mph to ft/s instantly with accurate results.',
  openGraph: {
    title: 'Miles per Hour to Feet per Second Converter',
    description: 'miles per hour to feet per second converter. Convert mph to ft/s instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Miles per Hour to Feet per Second Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            miles per hour to feet per second converter. Convert mph to ft/s instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mph to Fts conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mph = 733.333333333 fts</li>
                <li>1000 mph = 1466.66666667 fts</li>
                <li>5000 mph = 7333.33333333 fts</li>
                <li>10000 mph = 14666.6666667 fts</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mph to Fts</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mph as input and Fts as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mph to Fts conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mph to Fts?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mph, select Mph as input and Fts as output, then click convert.</p>
            </div>
            <div className="card p-6">
