...
export const metadata: Metadata = {
  title: 'Kilobits to TB Converter',
  description: 'kilobits to terabytes converter. Convert Kb to TB instantly with accurate results.',
  openGraph: {
    title: 'Kilobits to TB Converter',
    description: 'kilobits to terabytes converter. Convert Kb to TB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Kilobits to TB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            kilobits to terabytes converter. Convert Kb to TB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Kbit to Tb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Kbit to Tb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 kbit = 1.1641532183e-10 tb</li>
                <li>10 kbit = 1.1641532183e-9 tb</li>
                <li>50 kbit = 5.8207660913e-9 tb</li>
                <li>100 kbit = 1.1641532183e-8 tb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Tb to Kbit</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 tb = 8589934592 kbit</li>
                <li>10 tb = 85899345920 kbit</li>
                <li>50 tb = 429496729600 kbit</li>
                <li>100 tb = 858993459200 kbit</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 kbit = 5.8207660913e-8 tb</li>
                <li>1000 kbit = 1.1641532183e-7 tb</li>
                <li>5000 kbit = 5.8207660913e-7 tb</li>
                <li>10000 kbit = 0.00000116415321827 tb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Kbit to Tb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Kbit as input and Tb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Kbit to Tb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Kbit to Tb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Kbit, select Kbit as input and Tb as output, then click convert.</p>
            </div>
            <div className="card p-6">
