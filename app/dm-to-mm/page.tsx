...
export const metadata: Metadata = {
  title: 'Decimeters to Millimeters Converter',
  description: 'decimeters to millimeters converter. Convert dm to mm instantly with accurate results.',
  openGraph: {
    title: 'Decimeters to Millimeters Converter',
    description: 'decimeters to millimeters converter. Convert dm to mm instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Decimeters to Millimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            decimeters to millimeters converter. Convert dm to mm instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="dm" defaultTo="mm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Dm to Mm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Dm to Mm</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 dm = 100 mm</li>
                <li>10 dm = 1000 mm</li>
                <li>50 dm = 5000 mm</li>
                <li>100 dm = 10000 mm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mm to Dm</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mm = 0.01 dm</li>
                <li>10 mm = 0.1 dm</li>
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 dm = 50000 mm</li>
                <li>1000 dm = 100000 mm</li>
                <li>5000 dm = 500000 mm</li>
                <li>10000 dm = 1000000 mm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Dm to Mm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Dm as input and Mm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Dm to Mm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Dm to Mm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Dm, select Dm as input and Mm as output, then click convert.</p>
            </div>
            <div className="card p-6">
