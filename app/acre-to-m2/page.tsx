...
export const metadata: Metadata = {
  ...
  description: 'acres to square meters converter. Convert ac to m² instantly with accurate results.',
  openGraph: {
    title: 'Acres to Square Meters Converter',
    description: 'acres to square meters converter. Convert ac to m² instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Acres to Square Meters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            acres to square meters converter. Convert ac to m² instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="speed" defaultFrom="acre" defaultTo="m2" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Acre to M2 conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">acre to m²</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 acre = 4047 m²</li>
                <li>10 acre = 40470 m²</li>
                <li>50 acre = 202350 m²</li>
                <li>100 acre = 404700 m²</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">m² to acre</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 m² = 0.000247 acre</li>
                <li>10 m² = 0.00247 acre</li>
                <li>50 m² = 0.0124 acre</li>
                <li>100 m² = 0.0247 acre</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 acre = 2023500 m²</li>
                <li>1000 acre = 4047000 m²</li>
                <li>5000 acre = 20235000 m²</li>
                <li>10000 acre = 40470000 m²</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Acre to M2</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Acre as input and M2 as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Acre to M2 conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Acre to M2?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Acre, select Acre as input and M2 as output, then click convert.</p>
            </div>
            <div className="card p-6">
