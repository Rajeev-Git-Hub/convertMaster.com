...
export const metadata: Metadata = {
  ...
  description: 'square meters to acres converter. Convert m² to ac instantly with accurate results.',
  openGraph: {
    title: 'Square Meters to Acres Converter',
    description: 'square meters to acres converter. Convert m² to ac instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Meters to Acres Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square meters to acres converter. Convert m² to ac instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="area" defaultFrom="m2" defaultTo="acre" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for m² to acre conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 m² = 0.00025 acre</li>
                <li>10 m² = 0.0025 acre</li>
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li>10 acre = 40468.6 m²</li>
                <li>50 acre = 202343 m²</li>
                <li>100 acre = 404686 m²</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 m² = 0.1236 acre</li>
                <li>1000 m² = 0.2471 acre</li>
                <li>5000 m² = 1.2355 acre</li>
                <li>10000 m² = 2.4711 acre</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert m² to acre</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose m² as input and acre as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about m² to acre conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert m² to acre?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in m², select m² as input and acre as output, then click convert.</p>
            </div>
            <div className="card p-6">
