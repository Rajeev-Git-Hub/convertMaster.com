...
export const metadata: Metadata = {
  ...
  description: 'km/h to m/s converter. Convert kilometers per hour to meters per second instantly. 1 km/h = 0.277778 m/s. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'KM/H to Meters/sec Converter - Convert km/h to m/s',
    description: 'km/h to m/s converter. Convert kilometers per hour to meters per second instantly. 1 km/h = 0.277778 m/s. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">KM/H to Meters/sec Converter - Convert km/h to m/s</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            km/h to m/s converter. Convert kilometers per hour to meters per second instantly. 1 km/h = 0.277778 m/s. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="kmh" defaultTo="mps" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Kmh to Mps conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Kmh to Mps</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 kmh = 0.277777777778 mps</li>
                <li>10 kmh = 2.77777777778 mps</li>
                <li>50 kmh = 13.8888888889 mps</li>
                <li>100 kmh = 27.7777777778 mps</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mps to Kmh</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mps = 3.6 kmh</li>
                <li>10 mps = 36 kmh</li>
                <li>50 mps = 180 kmh</li>
                <li>100 mps = 360 kmh</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 kmh = 138.888888889 mps</li>
                <li>1000 kmh = 277.777777778 mps</li>
                <li>5000 kmh = 1388.88888889 mps</li>
                <li>10000 kmh = 2777.77777778 mps</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Kmh to Mps</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Kmh as input and Mps as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Kmh to Mps conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Kmh to Mps?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Kmh, select Kmh as input and Mps as output, then click convert.</p>
            </div>
            <div className="card p-6">
