...
export const metadata: Metadata = {
  title: 'Square Miles to Square Centimeters Converter',
  description: 'square miles to square centimeters converter. Convert mi² to cm² instantly with accurate results.',
  openGraph: {
    title: 'Square Miles to Square Centimeters Converter',
    description: 'square miles to square centimeters converter. Convert mi² to cm² instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Miles to Square Centimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square miles to square centimeters converter. Convert mi² to cm² instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="mi2" defaultTo="cm2" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mi2 to Cm2 conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mi² = 25900000000 cm²</li>
                <li>10 mi² = 259000000000 cm²</li>
                <li>50 mi² = 1295000000000 cm²</li>
                <li>100 mi² = 2590000000000 cm²</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 cm² = 0.0000000000386 mi²</li>
                <li>10 cm² = 0.000000000386 mi²</li>
                <li>50 cm² = 0.00000000193 mi²</li>
                <li>100 cm² = 0.00000000386 mi²</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mi² = 12950000000000 cm²</li>
                <li>1000 mi² = 25900000000000 cm²</li>
                <li>5000 mi² = 129500000000000 cm²</li>
                <li>10000 mi² = 259000000000000 cm²</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mi2 to Cm2</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mi2 as input and Cm2 as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mi2 to Cm2 conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mi2 to Cm2?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mi2, select Mi2 as input and Cm2 as output, then click convert.</p>
            </div>
            <div className="card p-6">
