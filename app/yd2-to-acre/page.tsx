...
export const metadata: Metadata = {
  title: 'Square Yards to Acres Converter',
  description: 'square yards to acres converter. Convert yd² to ac instantly with accurate results.',
  openGraph: {
    title: 'Square Yards to Acres Converter',
    description: 'square yards to acres converter. Convert yd² to ac instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Yards to Acres Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square yards to acres converter. Convert yd² to ac instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="speed" defaultFrom="yd2" defaultTo="acre" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Yd2 to Acre conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 yd² = 0.000206 acre</li>
                <li>10 yd² = 0.00206 acre</li>
                <li>50 yd² = 0.0103 acre</li>
                <li>100 yd² = 0.0206 acre</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 yd² = 0.103 acre</li>
                <li>1000 yd² = 0.206 acre</li>
                <li>5000 yd² = 1.03 acre</li>
                <li>10000 yd² = 2.06 acre</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Yd2 to Acre</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Yd2 as input and Acre as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Yd2 to Acre conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Yd2 to Acre?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Yd2, select Yd2 as input and Acre as output, then click convert.</p>
            </div>
            <div className="card p-6">
