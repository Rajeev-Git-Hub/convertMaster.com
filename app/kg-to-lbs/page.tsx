...
export const metadata: Metadata = {
  ...
  description: 'kg to lbs converter. Convert kilograms to pounds instantly with accurate results. Learn the conversion formula, see common conversions, and understand when to use each unit. Perfect for fitness, travel, and shipping.',
  openGraph: {
    title: 'KG to LBS Converter',
    description: 'kg to lbs converter. Convert kilograms to pounds instantly with accurate results. Learn the conversion formula, see common conversions, and understand when to use each unit. Perfect for fitness, travel, and shipping.',
    type: 'website',
      ...
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            kg to lbs converter. Convert kilograms to pounds instantly with accurate results. Learn the conversion formula, see common conversions, and understand when to use each unit. Perfect for fitness, travel, and shipping.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Kg to Lbs conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 kg = 1102.31131092 lbs</li>
                <li>1000 kg = 2204.62262185 lbs</li>
                <li>5000 kg = 11023.1131092 lbs</li>
                <li>10000 kg = 22046.2262185 lbs</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Kg to Lbs</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Kg as input and Lbs as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Kg to Lbs conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Kg to Lbs?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Kg, select Kg as input and Lbs as output, then click convert.</p>
            </div>
            <div className="card p-6">
