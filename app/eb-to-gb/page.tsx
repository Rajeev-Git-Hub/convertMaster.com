...
export const metadata: Metadata = {
  title: 'EB to GB Converter',
  description: 'exabytes to gigabytes converter. Convert EB to GB instantly with accurate results.',
  openGraph: {
    title: 'EB to GB Converter',
    description: 'exabytes to gigabytes converter. Convert EB to GB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">EB to GB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            exabytes to gigabytes converter. Convert EB to GB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Eb to Gb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 eb = 536870912000 gb</li>
                <li>1000 eb = 1073741824000 gb</li>
                <li>5000 eb = 5368709120000 gb</li>
                <li>10000 eb = 10737418240000 gb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Eb to Gb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Eb as input and Gb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Eb to Gb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Eb to Gb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Eb, select Eb as input and Gb as output, then click convert.</p>
            </div>
            <div className="card p-6">
