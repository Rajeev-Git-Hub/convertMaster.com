...
export const metadata: Metadata = {
  title: 'Megabits to TB Converter',
  description: 'megabits to terabytes converter. Convert Mb to TB instantly with accurate results.',
  openGraph: {
    title: 'Megabits to TB Converter',
    description: 'megabits to terabytes converter. Convert Mb to TB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Megabits to TB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            megabits to terabytes converter. Convert Mb to TB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mbit to Tb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mbit to Tb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mbit = 1.1920928955e-7 tb</li>
                <li>10 mbit = 0.00000119209289551 tb</li>
                <li>50 mbit = 0.00000596046447754 tb</li>
                <li>100 mbit = 0.0000119209289551 tb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Tb to Mbit</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 tb = 8388608 mbit</li>
                <li>10 tb = 83886080 mbit</li>
                <li>50 tb = 419430400 mbit</li>
                <li>100 tb = 838860800 mbit</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mbit = 0.0000596046447754 tb</li>
                <li>1000 mbit = 0.000119209289551 tb</li>
                <li>5000 mbit = 0.000596046447754 tb</li>
                <li>10000 mbit = 0.00119209289551 tb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mbit to Tb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mbit as input and Tb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mbit to Tb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mbit to Tb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mbit, select Mbit as input and Tb as output, then click convert.</p>
            </div>
            <div className="card p-6">
