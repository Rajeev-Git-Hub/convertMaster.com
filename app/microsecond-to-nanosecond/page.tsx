...
export const metadata: Metadata = {
  title: 'Microseconds to Nanoseconds Converter | Time Tool',
  description: 'Convert microseconds to nanoseconds instantly. 1 microsecond = 1,000 nanoseconds. online time converter with accurate results.',
  openGraph: {
    title: 'Microseconds to Nanoseconds Converter | Time Tool',
    description: 'Convert microseconds to nanoseconds instantly. 1 microsecond = 1,000 nanoseconds. online time converter with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Microseconds to Nanoseconds Converter | Time Tool</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Convert microseconds to nanoseconds instantly. 1 microsecond = 1,000 nanoseconds. online time converter with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="speed" defaultFrom="microsecond" defaultTo="nanosecond" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Microsecond to Nanosecond conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Microsecond to Nanosecond</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 microsecond = 1000 nanosecond</li>
                <li>10 microsecond = 10000 nanosecond</li>
                <li>50 microsecond = 50000 nanosecond</li>
                <li>100 microsecond = 100000 nanosecond</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Nanosecond to Microsecond</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 nanosecond = 0.001 microsecond</li>
                <li>10 nanosecond = 0.01 microsecond</li>
                <li>50 nanosecond = 0.05 microsecond</li>
                <li>100 nanosecond = 0.1 microsecond</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 microsecond = 500000 nanosecond</li>
                <li>1000 microsecond = 1000000 nanosecond</li>
                <li>5000 microsecond = 5000000 nanosecond</li>
                <li>10000 microsecond = 10000000 nanosecond</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Microsecond to Nanosecond</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Microsecond as input and Nanosecond as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Microsecond to Nanosecond conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Microsecond to Nanosecond?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Microsecond, select Microsecond as input and Nanosecond as output, then click convert.</p>
            </div>
            <div className="card p-6">
