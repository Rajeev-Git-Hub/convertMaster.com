...
export const metadata: Metadata = {
  ...
  description: 'megabytes to petabytes converter. Convert MB to PB instantly with accurate results.',
  openGraph: {
    title: 'MB to PB Converter',
    description: 'megabytes to petabytes converter. Convert MB to PB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">MB to PB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            megabytes to petabytes converter. Convert MB to PB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mb to Pb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mb to Pb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mb = 9.3132257462e-10 pb</li>
                <li>10 mb = 9.3132257462e-9 pb</li>
                <li>50 mb = 4.6566128731e-8 pb</li>
                <li>100 mb = 9.3132257462e-8 pb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Pb to Mb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 pb = 1073741824 mb</li>
                <li>10 pb = 10737418240 mb</li>
                <li>50 pb = 53687091200 mb</li>
                <li>100 pb = 107374182400 mb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mb = 4.6566128731e-7 pb</li>
                <li>1000 mb = 9.3132257462e-7 pb</li>
                <li>5000 mb = 0.00000465661287308 pb</li>
                <li>10000 mb = 0.00000931322574615 pb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mb to Pb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mb as input and Pb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mb to Pb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mb to Pb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mb, select Mb as input and Pb as output, then click convert.</p>
            </div>
            <div className="card p-6">
