...
export const metadata: Metadata = {
  title: 'Meters per Second to Speed of Light Converter',
  description: 'meters per second to speed of light converter. Convert m/s to c instantly with accurate results.',
  openGraph: {
    title: 'Meters per Second to Speed of Light Converter',
    description: 'meters per second to speed of light converter. Convert m/s to c instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Meters per Second to Speed of Light Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            meters per second to speed of light converter. Convert m/s to c instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mps to C conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mps to C</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mps = 3.335640952e-9 c</li>
                <li>10 mps = 3.335640952e-8 c</li>
                <li>50 mps = 1.667820476e-7 c</li>
                <li>100 mps = 3.335640952e-7 c</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">C to Mps</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 c = 299792458 mps</li>
                <li>10 c = 2997924580 mps</li>
                <li>50 c = 14989622900 mps</li>
                <li>100 c = 29979245800 mps</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mps = 0.00000166782047599 c</li>
                <li>1000 mps = 0.00000333564095198 c</li>
                <li>5000 mps = 0.0000166782047599 c</li>
                <li>10000 mps = 0.0000333564095198 c</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mps to C</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mps as input and C as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mps to C conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mps to C?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mps, select Mps as input and C as output, then click convert.</p>
            </div>
            <div className="card p-6">
