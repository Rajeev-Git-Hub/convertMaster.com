...
export const metadata: Metadata = {
  ...
  description: 'yards to miles converter. Convert yd to mi instantly with accurate results.',
  openGraph: {
    title: 'Yards to Miles Converter',
    description: 'yards to miles converter. Convert yd to mi instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Yards to Miles Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            yards to miles converter. Convert yd to mi instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="yards" defaultTo="miles" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Yards to Miles conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 yards = 0.284090909091 miles</li>
                <li>1000 yards = 0.568181818182 miles</li>
                <li>5000 yards = 2.84090909091 miles</li>
                <li>10000 yards = 5.68181818182 miles</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Yards to Miles</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Yards as input and Miles as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Yards to Miles conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Yards to Miles?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Yards, select Yards as input and Miles as output, then click convert.</p>
            </div>
            <div className="card p-6">
