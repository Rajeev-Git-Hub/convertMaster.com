...
export const metadata: Metadata = {
  ...
  description: 'kilograms to ounces converter. Convert kg to oz instantly with accurate results.',
  openGraph: {
    title: 'Kilograms to Ounces Converter',
    description: 'kilograms to ounces converter. Convert kg to oz instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Kilograms to Ounces Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            kilograms to ounces converter. Convert kg to oz instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="kg" defaultTo="ounce" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Kg to Ounce conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Kg to Ounce</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Kg as input and Ounce as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Kg to Ounce conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Kg to Ounce?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Kg, select Kg as input and Ounce as output, then click convert.</p>
            </div>
            <div className="card p-6">
