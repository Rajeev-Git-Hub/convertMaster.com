...
export const metadata: Metadata = {
  title: 'Square Meters to Square Miles Converter',
  description: 'square meters to square miles converter. Convert m² to mi² instantly with accurate results.',
  openGraph: {
    title: 'Square Meters to Square Miles Converter',
    description: 'square meters to square miles converter. Convert m² to mi² instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Meters to Square Miles Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square meters to square miles converter. Convert m² to mi² instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="area" defaultFrom="m2" defaultTo="mi2" />
          </div>
        </section>
