...
export const metadata: Metadata = {
  title: 'Square Kilometers to Square Yards Converter',
  description: 'square kilometers to square yards converter. Convert km² to yd² instantly with accurate results.',
  openGraph: {
    title: 'Square Kilometers to Square Yards Converter',
    description: 'square kilometers to square yards converter. Convert km² to yd² instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Kilometers to Square Yards Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square kilometers to square yards converter. Convert km² to yd² instantly with accurate results.. Get accurate results instantly.
          </p>
