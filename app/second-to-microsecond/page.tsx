...
export const metadata: Metadata = {
  title: 'Seconds to Microseconds Converter | Time Tool',
  description: 'Convert seconds to microseconds instantly. 1 second = 1,000,000 microseconds. online time converter with accurate results.',
  openGraph: {
    title: 'Seconds to Microseconds Converter | Time Tool',
    description: 'Convert seconds to microseconds instantly. 1 second = 1,000,000 microseconds. online time converter with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Seconds to Microseconds Converter | Time Tool</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Convert seconds to microseconds instantly. 1 second = 1,000,000 microseconds. online time converter with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="speed" defaultFrom="second" defaultTo="microsecond" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Second to Microsecond conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Second to Microsecond</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 second = 1000000 microsecond</li>
                <li>10 second = 10000000 microsecond</li>
                <li>50 second = 50000000 microsecond</li>
                <li>100 second = 100000000 microsecond</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Microsecond to Second</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 microsecond = 0.000001 second</li>
                <li>10 microsecond = 0.00001 second</li>
                <li>50 microsecond = 0.00005 second</li>
                <li>100 microsecond = 0.0001 second</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 second = 500000000 microsecond</li>
                <li>1000 second = 1000000000 microsecond</li>
                <li>5000 second = 5000000000 microsecond</li>
                <li>10000 second = 10000000000 microsecond</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Second to Microsecond</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Second as input and Microsecond as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Second to Microsecond conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Second to Microsecond?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Second, select Second as input and Microsecond as output, then click convert.</p>
            </div>
            <div className="card p-6">
