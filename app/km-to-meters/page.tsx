...
export const metadata: Metadata = {
  ...
  description: 'km to meters converter. Convert kilometers to meters instantly. 1 km = 1000 meters. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'KM to Meters Converter - Convert Kilometers to Meters',
    description: 'km to meters converter. Convert kilometers to meters instantly. 1 km = 1000 meters. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">KM to Meters Converter - Convert Kilometers to Meters</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            km to meters converter. Convert kilometers to meters instantly. 1 km = 1000 meters. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="km" defaultTo="meters" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Km to Meters conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Km to Meters</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 km = 1000 meters</li>
                <li>10 km = 10000 meters</li>
                <li>50 km = 50000 meters</li>
                <li>100 km = 100000 meters</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Meters to Km</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 meters = 0.001 km</li>
                <li>10 meters = 0.01 km</li>
                <li>50 meters = 0.05 km</li>
                <li>100 meters = 0.1 km</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 km = 500000 meters</li>
                <li>1000 km = 1000000 meters</li>
                <li>5000 km = 5000000 meters</li>
                <li>10000 km = 10000000 meters</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Km to Meters</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Km as input and Meters as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Km to Meters conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Km to Meters?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Km, select Km as input and Meters as output, then click convert.</p>
            </div>
            <div className="card p-6">
