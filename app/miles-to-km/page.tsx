...
export const metadata: Metadata = {
  ...
  description: 'miles to km converter. Convert miles to kilometers instantly. 1 mile = 1.60934 km. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'Miles to KM Converter - Convert Miles to Kilometers',
    description: 'miles to km converter. Convert miles to kilometers instantly. 1 mile = 1.60934 km. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Miles to KM Converter - Convert Miles to Kilometers</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            miles to km converter. Convert miles to kilometers instantly. 1 mile = 1.60934 km. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="miles" defaultTo="km" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Miles to Km conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 miles = 804.672 km</li>
                <li>1000 miles = 1609.344 km</li>
                <li>5000 miles = 8046.72 km</li>
                <li>10000 miles = 16093.44 km</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Miles to Km</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Miles as input and Km as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Miles to Km conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Miles to Km?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Miles, select Miles as input and Km as output, then click convert.</p>
            </div>
            <div className="card p-6">
