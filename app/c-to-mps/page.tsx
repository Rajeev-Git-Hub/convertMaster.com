...
export const metadata: Metadata = {
  title: 'Speed of Light to Meters per Second Converter',
  description: 'speed of light to meters per second converter. Convert c to m/s instantly with accurate results.',
  openGraph: {
    title: 'Speed of Light to Meters per Second Converter',
    description: 'speed of light to meters per second converter. Convert c to m/s instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Speed of Light to Meters per Second Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            speed of light to meters per second converter. Convert c to m/s instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for C to Mps conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 c = 149896229000 mps</li>
                <li>1000 c = 299792458000 mps</li>
                <li>5000 c = 1498962290000 mps</li>
                <li>10000 c = 2997924580000 mps</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert C to Mps</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose C as input and Mps as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about C to Mps conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert C to Mps?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in C, select C as input and Mps as output, then click convert.</p>
            </div>
            <div className="card p-6">
