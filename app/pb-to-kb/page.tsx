...
export const metadata: Metadata = {
  title: 'PB to KB Converter',
  description: 'petabytes to kilobytes converter. Convert PB to KB instantly with accurate results.',
  openGraph: {
    title: 'PB to KB Converter',
    description: 'petabytes to kilobytes converter. Convert PB to KB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">PB to KB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            petabytes to kilobytes converter. Convert PB to KB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Pb to Kb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Pb to Kb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 pb = 1099511627776 kb</li>
                <li>10 pb = 10995116277760 kb</li>
                <li>50 pb = 54975581388800 kb</li>
                <li>100 pb = 109951162777600 kb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Kb to Pb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 kb = 9.0949470177e-13 pb</li>
                <li>10 kb = 9.0949470177e-12 pb</li>
                <li>50 kb = 4.5474735089e-11 pb</li>
                <li>100 kb = 9.0949470177e-11 pb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 pb = 549755813888000 kb</li>
                <li>1000 pb = 1099511627776000 kb</li>
                <li>5000 pb = 5497558138880000 kb</li>
                <li>10000 pb = 1.0995116278e+16 kb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Pb to Kb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Pb as input and Kb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Pb to Kb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Pb to Kb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Pb, select Pb as input and Kb as output, then click convert.</p>
            </div>
            <div className="card p-6">
