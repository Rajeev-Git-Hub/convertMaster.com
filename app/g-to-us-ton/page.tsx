...
export const metadata: Metadata = {
  title: 'Grams to US Tons Converter',
  description: 'grams to US tons converter. Convert g to US ton instantly with accurate results.',
  openGraph: {
    title: 'Grams to US Tons Converter',
    description: 'grams to US tons converter. Convert g to US ton instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Grams to US Tons Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            grams to US tons converter. Convert g to US ton instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="g" defaultTo="us-ton" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for G to Us-ton conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 g = 0.00000110231131092 us-ton</li>
                <li>10 g = 0.0000110231131092 us-ton</li>
                <li>50 g = 0.0000551155655462 us-ton</li>
                <li>100 g = 0.000110231131092 us-ton</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 us-ton = 907184.74 g</li>
                <li>10 us-ton = 9071847.4 g</li>
                <li>50 us-ton = 45359237 g</li>
                <li>100 us-ton = 90718474 g</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 g = 0.000551155655462 us-ton</li>
                <li>1000 g = 0.00110231131092 us-ton</li>
                <li>5000 g = 0.00551155655462 us-ton</li>
                <li>10000 g = 0.0110231131092 us-ton</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert G to Us-ton</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose G as input and Us-ton as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about G to Us-ton conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert G to Us-ton?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in G, select G as input and Us-ton as output, then click convert.</p>
            </div>
            <div className="card p-6">
