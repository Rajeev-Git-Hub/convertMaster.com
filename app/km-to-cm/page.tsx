...
export const metadata: Metadata = {
  ...
  description: 'kilometers to centimeters converter. Convert km to cm instantly with accurate results.',
  openGraph: {
    title: 'Kilometers to Centimeters Converter',
    description: 'kilometers to centimeters converter. Convert km to cm instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Kilometers to Centimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            kilometers to centimeters converter. Convert km to cm instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="km" defaultTo="cm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Km to Cm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 km = 100000 cm</li>
                <li>10 km = 1000000 cm</li>
                <li>50 km = 5000000 cm</li>
                <li>100 km = 10000000 cm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 cm = 0.00001 km</li>
                <li>10 cm = 0.0001 km</li>
                <li>50 cm = 0.0005 km</li>
                <li>100 cm = 0.001 km</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 km = 50000000 cm</li>
                <li>1000 km = 100000000 cm</li>
                <li>5000 km = 500000000 cm</li>
                <li>10000 km = 1000000000 cm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Km to Cm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Km as input and Cm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Km to Cm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Km to Cm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Km, select Km as input and Cm as output, then click convert.</p>
            </div>
            <div className="card p-6">
