...
export const metadata: Metadata = {
  ...
  description: 'meters to yards converter. Convert meters to yards instantly. 1 meter = 1.09361 yards. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'Meters to Yards Converter - Convert Meters to Yards',
    description: 'meters to yards converter. Convert meters to yards instantly. 1 meter = 1.09361 yards. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Meters to Yards Converter - Convert Meters to Yards</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            meters to yards converter. Convert meters to yards instantly. 1 meter = 1.09361 yards. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="meters" defaultTo="yards" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Meters to Yards conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 meters = 1.09361329834 yards</li>
                <li>10 meters = 10.9361329834 yards</li>
                <li>50 meters = 54.6806649169 yards</li>
                <li>100 meters = 109.361329834 yards</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 meters = 546.806649169 yards</li>
                <li>1000 meters = 1093.61329834 yards</li>
                <li>5000 meters = 5468.06649169 yards</li>
                <li>10000 meters = 10936.1329834 yards</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Meters to Yards</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Meters as input and Yards as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Meters to Yards conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Meters to Yards?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Meters, select Meters as input and Yards as output, then click convert.</p>
            </div>
            <div className="card p-6">
