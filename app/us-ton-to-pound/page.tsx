...
export const metadata: Metadata = {
  title: 'US Tons to Pounds Converter',
  description: 'US tons to pounds converter. Convert US ton to lb instantly with accurate results.',
  openGraph: {
    title: 'US Tons to Pounds Converter',
    description: 'US tons to pounds converter. Convert US ton to lb instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">US Tons to Pounds Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            US tons to pounds converter. Convert US ton to lb instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Us-ton to Pound conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 us-ton = 1000000 pound</li>
                <li>1000 us-ton = 2000000 pound</li>
                <li>5000 us-ton = 10000000 pound</li>
                <li>10000 us-ton = 20000000 pound</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Us-ton to Pound</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Us-ton as input and Pound as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Us-ton to Pound conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Us-ton to Pound?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Us-ton, select Us-ton as input and Pound as output, then click convert.</p>
            </div>
            <div className="card p-6">
