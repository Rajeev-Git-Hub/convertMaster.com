...
export const metadata: Metadata = {
  ...
  description: 'm/s to mph converter. Convert meters per second to miles per hour instantly. 1 m/s = 2.23694 mph. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'Meters/sec to MPH Converter - Convert m/s to mph',
    description: 'm/s to mph converter. Convert meters per second to miles per hour instantly. 1 m/s = 2.23694 mph. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Meters/sec to MPH Converter - Convert m/s to mph</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            m/s to mph converter. Convert meters per second to miles per hour instantly. 1 m/s = 2.23694 mph. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mps to Mph conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mps to Mph</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mps as input and Mph as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mps to Mph conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mps to Mph?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mps, select Mps as input and Mph as output, then click convert.</p>
            </div>
            <div className="card p-6">
