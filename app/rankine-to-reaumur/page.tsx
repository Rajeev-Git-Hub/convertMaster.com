...
export const metadata: Metadata = {
  title: 'Rankine to Réaumur Converter',
  description: 'Rankine to Réaumur converter. Convert °R to °Ré instantly with accurate temperature conversion results.',
  openGraph: {
    title: 'Rankine to Réaumur Converter',
    description: 'Rankine to Réaumur converter. Convert °R to °Ré instantly with accurate temperature conversion results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Rankine to Réaumur Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Rankine to Réaumur converter. Convert °R to °Ré instantly with accurate temperature conversion results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Rankine to Reaumur conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 rankine ≈ ? reaumur</li>
                <li>10 rankine ≈ ? reaumur</li>
                <li>50 rankine ≈ ? reaumur</li>
                <li>100 rankine ≈ ? reaumur</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 reaumur ≈ ? rankine</li>
                <li>10 reaumur ≈ ? rankine</li>
                <li>50 reaumur ≈ ? rankine</li>
                <li>100 reaumur ≈ ? rankine</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 rankine ≈ ? reaumur</li>
                <li>1000 rankine ≈ ? reaumur</li>
                <li>5000 rankine ≈ ? reaumur</li>
                <li>10000 rankine ≈ ? reaumur</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Rankine to Reaumur</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Rankine as input and Reaumur as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Rankine to Reaumur conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Rankine to Reaumur?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Rankine, select Rankine as input and Reaumur as output, then click convert.</p>
            </div>
            <div className="card p-6">
