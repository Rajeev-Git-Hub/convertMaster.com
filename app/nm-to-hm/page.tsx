...
export const metadata: Metadata = {
  title: 'Nanometers to Hectometers Converter',
  description: 'nanometers to hectometers converter. Convert nm to hm instantly with accurate results.',
  openGraph: {
    title: 'Nanometers to Hectometers Converter',
    description: 'nanometers to hectometers converter. Convert nm to hm instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Nanometers to Hectometers Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            nanometers to hectometers converter. Convert nm to hm instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="nm" defaultTo="hm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Nm to Hm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 nm = 5e-9 hm</li>
                <li>1000 nm = 1e-8 hm</li>
                <li>5000 nm = 5e-8 hm</li>
                <li>10000 nm = 1e-7 hm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Nm to Hm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Nm as input and Hm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Nm to Hm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Nm to Hm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Nm, select Nm as input and Hm as output, then click convert.</p>
            </div>
            <div className="card p-6">
