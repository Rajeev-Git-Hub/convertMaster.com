...
export const metadata: Metadata = {
  title: 'Celsius to Réaumur Converter',
  description: 'Celsius to Réaumur converter. Convert °C to °Ré instantly with accurate temperature conversion results.',
  openGraph: {
    title: 'Celsius to Réaumur Converter',
    description: 'Celsius to Réaumur converter. Convert °C to °Ré instantly with accurate temperature conversion results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Celsius to Réaumur Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Celsius to Réaumur converter. Convert °C to °Ré instantly with accurate temperature conversion results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Celsius to Reaumur conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 celsius = 400 reaumur</li>
                <li>1000 celsius = 800 reaumur</li>
                <li>5000 celsius = 4000 reaumur</li>
                <li>10000 celsius = 8000 reaumur</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Celsius to Reaumur</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Celsius as input and Reaumur as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Celsius to Reaumur conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Celsius to Reaumur?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Celsius, select Celsius as input and Reaumur as output, then click convert.</p>
            </div>
            <div className="card p-6">
