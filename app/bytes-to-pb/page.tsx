...
export const metadata: Metadata = {
  title: 'Bytes to PB Converter',
  description: 'bytes to petabytes converter. Convert B to PB instantly with accurate results.',
  openGraph: {
    title: 'Bytes to PB Converter',
    description: 'bytes to petabytes converter. Convert B to PB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Bytes to PB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            bytes to petabytes converter. Convert B to PB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Bytes to Pb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 bytes = 4.4408920985e-13 pb</li>
                <li>1000 bytes = 8.881784197e-13 pb</li>
                <li>5000 bytes = 4.4408920985e-12 pb</li>
                <li>10000 bytes = 8.881784197e-12 pb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Bytes to Pb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Bytes as input and Pb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Bytes to Pb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Bytes to Pb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Bytes, select Bytes as input and Pb as output, then click convert.</p>
            </div>
            <div className="card p-6">
