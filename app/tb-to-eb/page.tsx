...
export const metadata: Metadata = {
  title: 'TB to EB Converter',
  description: 'terabytes to exabytes converter. Convert TB to EB instantly with accurate results.',
  openGraph: {
    title: 'TB to EB Converter',
    description: 'terabytes to exabytes converter. Convert TB to EB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">TB to EB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            terabytes to exabytes converter. Convert TB to EB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Tb to Eb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Tb to Eb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 tb = 9.5367431641e-7 eb</li>
                <li>10 tb = 0.00000953674316406 eb</li>
                <li>50 tb = 0.0000476837158203 eb</li>
                <li>100 tb = 0.0000953674316406 eb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Eb to Tb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 eb = 1048576 tb</li>
                <li>10 eb = 10485760 tb</li>
                <li>50 eb = 52428800 tb</li>
                <li>100 eb = 104857600 tb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 tb = 0.000476837158203 eb</li>
                <li>1000 tb = 0.000953674316406 eb</li>
                <li>5000 tb = 0.00476837158203 eb</li>
                <li>10000 tb = 0.00953674316406 eb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Tb to Eb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Tb as input and Eb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Tb to Eb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Tb to Eb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Tb, select Tb as input and Eb as output, then click convert.</p>
            </div>
            <div className="card p-6">
