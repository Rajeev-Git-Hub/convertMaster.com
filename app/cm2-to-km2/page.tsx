...
export const metadata: Metadata = {
  title: 'Square Centimeters to Square Kilometers Converter',
  description: 'square centimeters to square kilometers converter. Convert cm² to km² instantly with accurate results.',
  openGraph: {
    title: 'Square Centimeters to Square Kilometers Converter',
    description: 'square centimeters to square kilometers converter. Convert cm² to km² instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Centimeters to Square Kilometers Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square centimeters to square kilometers converter. Convert cm² to km² instantly with accurate results.. Get accurate results instantly.
          </p>
