...
export const metadata: Metadata = {
  title: 'Centimeter to Millimeter Converter (& Instant) | ConvertMaster',
  description: 'Convert centimeters to millimeters instantly. 1 cm = 10 mm. online converter with smart explanations and examples.',
  openGraph: {
    title: 'Centimeter to Millimeter Converter (& Instant) | ConvertMaster',
    description: 'Convert centimeters to millimeters instantly. 1 cm = 10 mm. online converter with smart explanations and examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Centimeter to Millimeter Converter (& Instant) | ConvertMaster</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Convert centimeters to millimeters instantly. 1 cm = 10 mm. online converter with smart explanations and examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="cm" defaultTo="mm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Cm to Mm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 cm = 5000 mm</li>
                <li>1000 cm = 10000 mm</li>
                <li>5000 cm = 50000 mm</li>
                <li>10000 cm = 100000 mm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Cm to Mm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Cm as input and Mm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Cm to Mm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Cm to Mm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Cm, select Cm as input and Mm as output, then click convert.</p>
            </div>
            <div className="card p-6">
