...
export const metadata: Metadata = {
  title: 'Minutes to Weeks Converter | Time Tool',
  description: 'Convert minutes to weeks instantly. 1 week = 10080 minutes. online time converter with accurate results.',
  openGraph: {
    title: 'Minutes to Weeks Converter | Time Tool',
    description: 'Convert minutes to weeks instantly. 1 week = 10080 minutes. online time converter with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Minutes to Weeks Converter | Time Tool</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Convert minutes to weeks instantly. 1 week = 10080 minutes. online time converter with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Minute to Week conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Minute to Week</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Minute as input and Week as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Minute to Week conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Minute to Week?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Minute, select Minute as input and Week as output, then click convert.</p>
            </div>
            <div className="card p-6">
