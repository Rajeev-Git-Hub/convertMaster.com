...
export const metadata: Metadata = {
  ...
  description: 'meters to centimeters converter. Convert m to cm instantly with accurate results. Perfect for measuring lengths, heights, and everyday distances.',
  openGraph: {
    title: 'Meters to Centimeters Converter',
    description: 'meters to centimeters converter. Convert m to cm instantly with accurate results. Perfect for measuring lengths, heights, and everyday distances.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Meters to Centimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            meters to centimeters converter. Convert m to cm instantly with accurate results. Perfect for measuring lengths, heights, and everyday distances.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="meters" defaultTo="cm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Meters to Cm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Meters to Cm</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 meters = 100 cm</li>
                <li>10 meters = 1000 cm</li>
                <li>50 meters = 5000 cm</li>
                <li>100 meters = 10000 cm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Cm to Meters</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 cm = 0.01 meters</li>
                <li>10 cm = 0.1 meters</li>
                <li>50 cm = 0.5 meters</li>
                <li>100 cm = 1 meters</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 meters = 50000 cm</li>
                <li>1000 meters = 100000 cm</li>
                <li>5000 meters = 500000 cm</li>
                <li>10000 meters = 1000000 cm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Meters to Cm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Meters as input and Cm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Meters to Cm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Meters to Cm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Meters, select Meters as input and Cm as output, then click convert.</p>
            </div>
            <div className="card p-6">
