...
export const metadata: Metadata = {
  title: 'Micrometers to Millimeters Converter',
  description: 'micrometers to millimeters converter. Convert μm to mm instantly with accurate results. Perfect for precision engineering, manufacturing, and scientific measurements.',
  openGraph: {
    title: 'Micrometers to Millimeters Converter',
    description: 'micrometers to millimeters converter. Convert μm to mm instantly with accurate results. Perfect for precision engineering, manufacturing, and scientific measurements.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Micrometers to Millimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            micrometers to millimeters converter. Convert μm to mm instantly with accurate results. Perfect for precision engineering, manufacturing, and scientific measurements.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="micrometers" defaultTo="mm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Micrometers to Mm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 micrometers = 0.5 mm</li>
                <li>1000 micrometers = 1 mm</li>
                <li>5000 micrometers = 5 mm</li>
                <li>10000 micrometers = 10 mm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Micrometers to Mm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Micrometers as input and Mm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Micrometers to Mm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Micrometers to Mm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Micrometers, select Micrometers as input and Mm as output, then click convert.</p>
            </div>
            <div className="card p-6">
