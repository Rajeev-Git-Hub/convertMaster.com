...
export const metadata: Metadata = {
  title: 'US Tons to Grams Converter',
  description: 'US tons to grams converter. Convert US ton to g instantly with accurate results.',
  openGraph: {
    title: 'US Tons to Grams Converter',
    description: 'US tons to grams converter. Convert US ton to g instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">US Tons to Grams Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            US tons to grams converter. Convert US ton to g instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="us-ton" defaultTo="g" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Us-ton to G conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 us-ton = 453592370 g</li>
                <li>1000 us-ton = 907184740 g</li>
                <li>5000 us-ton = 4535923700 g</li>
                <li>10000 us-ton = 9071847400 g</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Us-ton to G</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Us-ton as input and G as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Us-ton to G conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Us-ton to G?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Us-ton, select Us-ton as input and G as output, then click convert.</p>
            </div>
            <div className="card p-6">
