...
export const metadata: Metadata = {
  title: 'Cubic Inches to Fluid Ounces Converter',
  description: 'cubic inches to fluid ounces converter. Convert in³ to fl oz instantly with accurate results.',
  openGraph: {
    title: 'Cubic Inches to Fluid Ounces Converter',
    description: 'cubic inches to fluid ounces converter. Convert in³ to fl oz instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Cubic Inches to Fluid Ounces Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            cubic inches to fluid ounces converter. Convert in³ to fl oz instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="in3" defaultTo="floz" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for In3 to Floz conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">In3 to Floz</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 in3 = 0.554112554113 floz</li>
                <li>10 in3 = 5.54112554113 floz</li>
                <li>50 in3 = 27.7056277056 floz</li>
                <li>100 in3 = 55.4112554113 floz</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Floz to In3</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 floz = 1.8046875 in3</li>
                <li>10 floz = 18.046875 in3</li>
                <li>50 floz = 90.234375 in3</li>
                <li>100 floz = 180.46875 in3</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 in3 = 277.056277056 floz</li>
                <li>1000 in3 = 554.112554113 floz</li>
                <li>5000 in3 = 2770.56277056 floz</li>
                <li>10000 in3 = 5541.12554113 floz</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert In3 to Floz</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose In3 as input and Floz as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about In3 to Floz conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert In3 to Floz?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in In3, select In3 as input and Floz as output, then click convert.</p>
            </div>
            <div className="card p-6">
