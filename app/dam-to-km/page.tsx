...
export const metadata: Metadata = {
  title: 'Dekameters to Kilometers Converter',
  description: 'dekameters to kilometers converter. Convert dam to km instantly with accurate results.',
  openGraph: {
    title: 'Dekameters to Kilometers Converter',
    description: 'dekameters to kilometers converter. Convert dam to km instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Dekameters to Kilometers Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            dekameters to kilometers converter. Convert dam to km instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="dam" defaultTo="km" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Dam to Km conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 dam = 5 km</li>
                <li>1000 dam = 10 km</li>
                <li>5000 dam = 50 km</li>
                <li>10000 dam = 100 km</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Dam to Km</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Dam as input and Km as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Dam to Km conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Dam to Km?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Dam, select Dam as input and Km as output, then click convert.</p>
            </div>
            <div className="card p-6">
