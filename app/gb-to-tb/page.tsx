...
export const metadata: Metadata = {
  ...
  description: 'GB to TB converter. Convert gigabytes to terabytes instantly. 1 TB = 1024 GB. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'GB to TB Converter - Convert Gigabytes to Terabytes',
    description: 'GB to TB converter. Convert gigabytes to terabytes instantly. 1 TB = 1024 GB. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">GB to TB Converter - Convert Gigabytes to Terabytes</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            GB to TB converter. Convert gigabytes to terabytes instantly. 1 TB = 1024 GB. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="data" defaultFrom="gb" defaultTo="tb" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Gb to Tb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 gb = 0.0009765625 tb</li>
                <li>10 gb = 0.009765625 tb</li>
                <li>50 gb = 0.048828125 tb</li>
                <li>100 gb = 0.09765625 tb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 tb = 1024 gb</li>
                <li>10 tb = 10240 gb</li>
                <li>50 tb = 51200 gb</li>
                <li>100 tb = 102400 gb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 gb = 0.48828125 tb</li>
                <li>1000 gb = 0.9765625 tb</li>
                <li>5000 gb = 4.8828125 tb</li>
                <li>10000 gb = 9.765625 tb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Gb to Tb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Gb as input and Tb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Gb to Tb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Gb to Tb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Gb, select Gb as input and Tb as output, then click convert.</p>
            </div>
            <div className="card p-6">
