...
export const metadata: Metadata = {
  ...
  description: 'GB to MB converter. Convert gigabytes to megabytes instantly. 1 GB = 1024 MB. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'GB to MB Converter - Convert Gigabytes to Megabytes',
    description: 'GB to MB converter. Convert gigabytes to megabytes instantly. 1 GB = 1024 MB. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">GB to MB Converter - Convert Gigabytes to Megabytes</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            GB to MB converter. Convert gigabytes to megabytes instantly. 1 GB = 1024 MB. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="data" defaultFrom="gb" defaultTo="mb" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Gb to Mb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 gb = 512000 mb</li>
                <li>1000 gb = 1024000 mb</li>
                <li>5000 gb = 5120000 mb</li>
                <li>10000 gb = 10240000 mb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Gb to Mb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Gb as input and Mb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Gb to Mb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Gb to Mb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Gb, select Gb as input and Mb as output, then click convert.</p>
            </div>
            <div className="card p-6">
