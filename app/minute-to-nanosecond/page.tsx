...
export const metadata: Metadata = {
  title: 'Minutes to Nanoseconds Converter | Time Tool',
  description: 'Convert minutes to nanoseconds instantly. 1 minute = 60,000,000,000 nanoseconds. online time converter with accurate results.',
  openGraph: {
    title: 'Minutes to Nanoseconds Converter | Time Tool',
    description: 'Convert minutes to nanoseconds instantly. 1 minute = 60,000,000,000 nanoseconds. online time converter with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Minutes to Nanoseconds Converter | Time Tool</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Convert minutes to nanoseconds instantly. 1 minute = 60,000,000,000 nanoseconds. online time converter with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="speed" defaultFrom="minute" defaultTo="nanosecond" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Minute to Nanosecond conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Minute to Nanosecond</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Minute as input and Nanosecond as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Minute to Nanosecond conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Minute to Nanosecond?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Minute, select Minute as input and Nanosecond as output, then click convert.</p>
            </div>
            <div className="card p-6">
