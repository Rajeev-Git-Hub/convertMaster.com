...
export const metadata: Metadata = {
  title: 'Meters to Nanometers Converter',
  description: 'meters to nanometers converter. Convert m to nm instantly with accurate results. Perfect for nanotechnology and scientific research.',
  openGraph: {
    title: 'Meters to Nanometers Converter',
    description: 'meters to nanometers converter. Convert m to nm instantly with accurate results. Perfect for nanotechnology and scientific research.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Meters to Nanometers Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            meters to nanometers converter. Convert m to nm instantly with accurate results. Perfect for nanotechnology and scientific research.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="meters" defaultTo="nm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Meters to Nm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Meters to Nm</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 meters = 1000000000 nm</li>
                <li>10 meters = 10000000000 nm</li>
                <li>50 meters = 50000000000 nm</li>
                <li>100 meters = 100000000000 nm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Nm to Meters</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 nm = 0.000000001 meters</li>
                <li>10 nm = 0.00000001 meters</li>
                <li>50 nm = 0.00000005 meters</li>
                <li>100 nm = 0.0000001 meters</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 meters = 500000000000 nm</li>
                <li>1000 meters = 1000000000000 nm</li>
                <li>5000 meters = 5000000000000 nm</li>
                <li>10000 meters = 10000000000000 nm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Meters to Nm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Meters as input and Nm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Meters to Nm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Meters to Nm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Meters, select Meters as input and Nm as output, then click convert.</p>
            </div>
            <div className="card p-6">
