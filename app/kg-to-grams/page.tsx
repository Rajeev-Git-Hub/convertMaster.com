...
export const metadata: Metadata = {
  ...
  description: 'kg to grams converter. Convert kilograms to grams instantly. 1 kg = 1000 grams. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'KG to Grams Converter - Convert Kilograms to Grams',
    description: 'kg to grams converter. Convert kilograms to grams instantly. 1 kg = 1000 grams. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">KG to Grams Converter - Convert Kilograms to Grams</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            kg to grams converter. Convert kilograms to grams instantly. 1 kg = 1000 grams. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Kg to Grams conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Kg to Grams</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Kg as input and Grams as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Kg to Grams conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Kg to Grams?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Kg, select Kg as input and Grams as output, then click convert.</p>
            </div>
            <div className="card p-6">
