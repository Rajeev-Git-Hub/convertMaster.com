...
export const metadata: Metadata = {
  title: 'Centimeters to Miles Converter',
  description: 'centimeters to miles converter. Convert cm to mi instantly with accurate results.',
  openGraph: {
    title: 'Centimeters to Miles Converter',
    description: 'centimeters to miles converter. Convert cm to mi instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Centimeters to Miles Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            centimeters to miles converter. Convert cm to mi instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="cm" defaultTo="miles" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Cm to Miles conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 cm = 0.00000621371192237 miles</li>
                <li>10 cm = 0.0000621371192237 miles</li>
                <li>50 cm = 0.000310685596119 miles</li>
                <li>100 cm = 0.000621371192237 miles</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 miles = 160934.4 cm</li>
                <li>10 miles = 1609344 cm</li>
                <li>50 miles = 8046720 cm</li>
                <li>100 miles = 16093440 cm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 cm = 0.00310685596119 miles</li>
                <li>1000 cm = 0.00621371192237 miles</li>
                <li>5000 cm = 0.0310685596119 miles</li>
                <li>10000 cm = 0.0621371192237 miles</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Cm to Miles</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Cm as input and Miles as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Cm to Miles conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Cm to Miles?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Cm, select Cm as input and Miles as output, then click convert.</p>
            </div>
            <div className="card p-6">
