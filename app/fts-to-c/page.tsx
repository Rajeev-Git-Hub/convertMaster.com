...
export const metadata: Metadata = {
  title: 'Feet per Second to Speed of Light Converter',
  description: 'feet per second to speed of light converter. Convert ft/s to c instantly with accurate results.',
  openGraph: {
    title: 'Feet per Second to Speed of Light Converter',
    description: 'feet per second to speed of light converter. Convert ft/s to c instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Feet per Second to Speed of Light Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            feet per second to speed of light converter. Convert ft/s to c instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Fts to C conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 fts = 5.0835168108e-7 c</li>
                <li>1000 fts = 0.00000101670336216 c</li>
                <li>5000 fts = 0.00000508351681082 c</li>
                <li>10000 fts = 0.0000101670336216 c</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Fts to C</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Fts as input and C as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Fts to C conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Fts to C?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Fts, select Fts as input and C as output, then click convert.</p>
            </div>
            <div className="card p-6">
