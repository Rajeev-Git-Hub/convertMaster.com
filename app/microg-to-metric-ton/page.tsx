...
export const metadata: Metadata = {
  title: 'Micrograms to Metric Tons Converter',
  description: 'micrograms to metric tons converter. Convert μg to t instantly with accurate results.',
  openGraph: {
    title: 'Micrograms to Metric Tons Converter',
    description: 'micrograms to metric tons converter. Convert μg to t instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Micrograms to Metric Tons Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            micrograms to metric tons converter. Convert μg to t instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="microg" defaultTo="metric-ton" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Microg to Metric-ton conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 microg = 5e-10 metric-ton</li>
                <li>1000 microg = 1e-9 metric-ton</li>
                <li>5000 microg = 5e-9 metric-ton</li>
                <li>10000 microg = 1e-8 metric-ton</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Microg to Metric-ton</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Microg as input and Metric-ton as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Microg to Metric-ton conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Microg to Metric-ton?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Microg, select Microg as input and Metric-ton as output, then click convert.</p>
            </div>
            <div className="card p-6">
