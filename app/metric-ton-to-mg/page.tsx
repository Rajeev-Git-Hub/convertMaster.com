...
export const metadata: Metadata = {
  title: 'Metric Tons to Milligrams Converter',
  description: 'metric tons to milligrams converter. Convert t to mg instantly with accurate results.',
  openGraph: {
    title: 'Metric Tons to Milligrams Converter',
    description: 'metric tons to milligrams converter. Convert t to mg instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Metric Tons to Milligrams Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            metric tons to milligrams converter. Convert t to mg instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="metric-ton" defaultTo="mg" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Metric-ton to Mg conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Metric-ton to Mg</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Metric-ton as input and Mg as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Metric-ton to Mg conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Metric-ton to Mg?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Metric-ton, select Metric-ton as input and Mg as output, then click convert.</p>
            </div>
            <div className="card p-6">
