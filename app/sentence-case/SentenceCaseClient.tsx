...
export default function SentenceCaseClient() {
  ...
  useEffect(() => {
    if (input) {
      setOutput(convertToSentenceCase(input));
    } else {
      setOutput('');
    }
  }, [input]);
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-r-lg">
        <p className="text-sm text-blue-700">
          <strong>Sentence case</strong> capitalizes the first letter of each sentence while keeping the rest lowercase. 
          Perfect for articles, essays, and prose writing.
        </p>
      </div>
        ...
        <div className="relative">
          <div className="flex items-center justify-between mb-2">
            <label className="text-sm font-semibold text-gray-700 flex items-center gap-2">
              ...
              Output — <span className="text-blue-600">Sentence case</span>
            </label>
            <div className="flex gap-2">
              {output && (
                <>
