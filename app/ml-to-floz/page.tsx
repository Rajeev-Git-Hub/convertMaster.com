...
export const metadata: Metadata = {
  ...
  description: 'milliliters to fluid ounces converter. Convert mL to fl oz instantly with accurate results.',
  openGraph: {
    title: 'Milliliters to Fluid Ounces Converter',
    description: 'milliliters to fluid ounces converter. Convert mL to fl oz instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Milliliters to Fluid Ounces Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            milliliters to fluid ounces converter. Convert mL to fl oz instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="ml" defaultTo="floz" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Ml to Floz conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 ml = 16.9070113509 floz</li>
                <li>1000 ml = 33.8140227018 floz</li>
                <li>5000 ml = 169.070113509 floz</li>
                <li>10000 ml = 338.140227018 floz</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Ml to Floz</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Ml as input and Floz as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Ml to Floz conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Ml to Floz?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Ml, select Ml as input and Floz as output, then click convert.</p>
            </div>
            <div className="card p-6">
