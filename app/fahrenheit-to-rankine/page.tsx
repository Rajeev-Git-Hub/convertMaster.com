...
export const metadata: Metadata = {
  ...
  description: 'Fahrenheit to Rankine converter. Convert °F to °R instantly with accurate temperature conversion results.',
  openGraph: {
    title: 'Fahrenheit to Rankine Converter',
    description: 'Fahrenheit to Rankine converter. Convert °F to °R instantly with accurate temperature conversion results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Fahrenheit to Rankine Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Fahrenheit to Rankine converter. Convert °F to °R instantly with accurate temperature conversion results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Fahrenheit to Rankine conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 fahrenheit ≈ ? rankine</li>
                <li>1000 fahrenheit ≈ ? rankine</li>
                <li>5000 fahrenheit ≈ ? rankine</li>
                <li>10000 fahrenheit ≈ ? rankine</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Fahrenheit to Rankine</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Fahrenheit as input and Rankine as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Fahrenheit to Rankine conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Fahrenheit to Rankine?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Fahrenheit, select Fahrenheit as input and Rankine as output, then click convert.</p>
            </div>
            <div className="card p-6">
