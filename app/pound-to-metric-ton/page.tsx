        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 pound = 0.226796185 metric-ton</li>
                <li>1000 pound = 0.45359237 metric-ton</li>
                <li>5000 pound = 2.26796185 metric-ton</li>
                <li>10000 pound = 4.5359237 metric-ton</li>
              </ul>
            </div>
          </div>
        </section>
