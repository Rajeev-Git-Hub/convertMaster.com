...
export const metadata: Metadata = {
  ...
  description: 'mg to grams converter. Convert milligrams to grams instantly. 1 mg = 0.001 grams. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'MG to Grams Converter - Convert Milligrams to Grams',
    description: 'mg to grams converter. Convert milligrams to grams instantly. 1 mg = 0.001 grams. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">MG to Grams Converter - Convert Milligrams to Grams</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            mg to grams converter. Convert milligrams to grams instantly. 1 mg = 0.001 grams. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="mg" defaultTo="grams" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mg to Grams conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mg to Grams</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mg as input and Grams as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mg to Grams conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mg to Grams?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mg, select Mg as input and Grams as output, then click convert.</p>
            </div>
            <div className="card p-6">
