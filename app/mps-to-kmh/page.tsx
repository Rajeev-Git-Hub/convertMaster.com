...
export const metadata: Metadata = {
  ...
  description: 'm/s to km/h converter. Convert meters per second to kilometers per hour instantly. 1 m/s = 3.6 km/h. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'Meters/sec to KM/H Converter - Convert m/s to km/h',
    description: 'm/s to km/h converter. Convert meters per second to kilometers per hour instantly. 1 m/s = 3.6 km/h. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Meters/sec to KM/H Converter - Convert m/s to km/h</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            m/s to km/h converter. Convert meters per second to kilometers per hour instantly. 1 m/s = 3.6 km/h. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="mps" defaultTo="kmh" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mps to Kmh conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mps = 1800 kmh</li>
                <li>1000 mps = 3600 kmh</li>
                <li>5000 mps = 18000 kmh</li>
                <li>10000 mps = 36000 kmh</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mps to Kmh</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mps as input and Kmh as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mps to Kmh conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mps to Kmh?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mps, select Mps as input and Kmh as output, then click convert.</p>
            </div>
            <div className="card p-6">
