...
export const metadata: Metadata = {
  title: 'Bits to PB Converter',
  description: 'bits to petabytes converter. Convert bit to PB instantly with accurate results.',
  openGraph: {
    title: 'Bits to PB Converter',
    description: 'bits to petabytes converter. Convert bit to PB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Bits to PB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            bits to petabytes converter. Convert bit to PB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Bit to Pb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Bit to Pb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 bit = 0 pb</li>
                <li>10 bit = 1.1102230246e-15 pb</li>
                <li>50 bit = 5.5511151231e-15 pb</li>
                <li>100 bit = 1.1102230246e-14 pb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Pb to Bit</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 pb = 9.0071992547e+15 bit</li>
                <li>10 pb = 9.0071992547e+16 bit</li>
                <li>50 pb = 4.5035996274e+17 bit</li>
                <li>100 pb = 9.0071992547e+17 bit</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 bit = 5.5511151231e-14 pb</li>
                <li>1000 bit = 1.1102230246e-13 pb</li>
                <li>5000 bit = 5.5511151231e-13 pb</li>
                <li>10000 bit = 1.1102230246e-12 pb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Bit to Pb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Bit as input and Pb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Bit to Pb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Bit to Pb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Bit, select Bit as input and Pb as output, then click convert.</p>
            </div>
            <div className="card p-6">
