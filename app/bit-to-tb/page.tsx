...
export const metadata: Metadata = {
  title: 'Bits to TB Converter',
  description: 'bits to terabytes converter. Convert bit to TB instantly with accurate results.',
  openGraph: {
    title: 'Bits to TB Converter',
    description: 'bits to terabytes converter. Convert bit to TB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Bits to TB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            bits to terabytes converter. Convert bit to TB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Bit to Tb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Bit to Tb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 bit = 1.1368683772e-13 tb</li>
                <li>10 bit = 1.1368683772e-12 tb</li>
                <li>50 bit = 5.6843418861e-12 tb</li>
                <li>100 bit = 1.1368683772e-11 tb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Tb to Bit</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 tb = 8796093022208 bit</li>
                <li>10 tb = 87960930222080 bit</li>
                <li>50 tb = 439804651110400 bit</li>
                <li>100 tb = 879609302220800 bit</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 bit = 5.6843418861e-11 tb</li>
                <li>1000 bit = 1.1368683772e-10 tb</li>
                <li>5000 bit = 5.6843418861e-10 tb</li>
                <li>10000 bit = 1.1368683772e-9 tb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Bit to Tb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Bit as input and Tb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Bit to Tb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Bit to Tb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Bit, select Bit as input and Tb as output, then click convert.</p>
            </div>
            <div className="card p-6">
