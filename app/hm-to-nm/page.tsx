...
export const metadata: Metadata = {
  title: 'Hectometers to Nanometers Converter',
  description: 'hectometers to nanometers converter. Convert hm to nm instantly with accurate results.',
  openGraph: {
    title: 'Hectometers to Nanometers Converter',
    description: 'hectometers to nanometers converter. Convert hm to nm instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Hectometers to Nanometers Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            hectometers to nanometers converter. Convert hm to nm instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="hm" defaultTo="nm" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Hm to Nm conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Hm to Nm</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 hm = 100000000000 nm</li>
                <li>10 hm = 1000000000000 nm</li>
                <li>50 hm = 5000000000000 nm</li>
                <li>100 hm = 10000000000000 nm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 hm = 50000000000000 nm</li>
                <li>1000 hm = 100000000000000 nm</li>
                <li>5000 hm = 500000000000000 nm</li>
                <li>10000 hm = 1000000000000000 nm</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Hm to Nm</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Hm as input and Nm as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Hm to Nm conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Hm to Nm?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Hm, select Hm as input and Nm as output, then click convert.</p>
            </div>
            <div className="card p-6">
