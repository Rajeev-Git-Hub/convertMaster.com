...
export const metadata: Metadata = {
  title: 'Seconds to Days Converter | Time Tool',
  description: 'Convert seconds to days instantly. 1 day = 86400 seconds. online time converter with accurate results.',
  openGraph: {
    title: 'Seconds to Days Converter | Time Tool',
    description: 'Convert seconds to days instantly. 1 day = 86400 seconds. online time converter with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Seconds to Days Converter | Time Tool</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Convert seconds to days instantly. 1 day = 86400 seconds. online time converter with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="speed" defaultFrom="second" defaultTo="day" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Second to Day conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 second = 0.00578703703704 day</li>
                <li>1000 second = 0.0115740740741 day</li>
                <li>5000 second = 0.0578703703704 day</li>
                <li>10000 second = 0.115740740741 day</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Second to Day</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Second as input and Day as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Second to Day conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Second to Day?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Second, select Second as input and Day as output, then click convert.</p>
            </div>
            <div className="card p-6">
