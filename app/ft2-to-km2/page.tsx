...
export const metadata: Metadata = {
  title: 'Square Feet to Square Kilometers Converter',
  description: 'square feet to square kilometers converter. Convert ft² to km² instantly with accurate results.',
  openGraph: {
    title: 'Square Feet to Square Kilometers Converter',
    description: 'square feet to square kilometers converter. Convert ft² to km² instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Feet to Square Kilometers Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square feet to square kilometers converter. Convert ft² to km² instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="ft2" defaultTo="km2" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Ft2 to Km2 conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 km² = 10760000 ft²</li>
                <li>10 km² = 107600000 ft²</li>
                <li>50 km² = 538000000 ft²</li>
                <li>100 km² = 1076000000 ft²</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 ft² = 0.00004645 km²</li>
                <li>1000 ft² = 0.0000929 km²</li>
                <li>5000 ft² = 0.0004645 km²</li>
                <li>10000 ft² = 0.000929 km²</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Ft2 to Km2</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Ft2 as input and Km2 as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Ft2 to Km2 conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Ft2 to Km2?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Ft2, select Ft2 as input and Km2 as output, then click convert.</p>
            </div>
            <div className="card p-6">
