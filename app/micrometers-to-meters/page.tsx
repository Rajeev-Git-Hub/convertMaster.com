...
export const metadata: Metadata = {
  title: 'Micrometers to Meters Converter',
  description: 'micrometers to meters converter. Convert μm to m instantly with accurate results.',
  openGraph: {
    title: 'Micrometers to Meters Converter',
    description: 'micrometers to meters converter. Convert μm to m instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Micrometers to Meters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            micrometers to meters converter. Convert μm to m instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="micrometers" defaultTo="meters" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Micrometers to Meters conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 micrometers = 0.0005 meters</li>
                <li>1000 micrometers = 0.001 meters</li>
                <li>5000 micrometers = 0.005 meters</li>
                <li>10000 micrometers = 0.01 meters</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Micrometers to Meters</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Micrometers as input and Meters as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Micrometers to Meters conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Micrometers to Meters?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Micrometers, select Micrometers as input and Meters as output, then click convert.</p>
            </div>
            <div className="card p-6">
