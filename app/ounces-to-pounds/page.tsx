...
export const metadata: Metadata = {
  ...
  description: 'ounces to pounds converter. Convert ounces to pounds instantly. 16 ounces = 1 pound. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'Ounces to Pounds Converter - Convert Ounces to Pounds',
    description: 'ounces to pounds converter. Convert ounces to pounds instantly. 16 ounces = 1 pound. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Ounces to Pounds Converter - Convert Ounces to Pounds</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            ounces to pounds converter. Convert ounces to pounds instantly. 16 ounces = 1 pound. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="ounces" defaultTo="pounds" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Ounces to Pounds conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 ounces ≈ ? pounds</li>
                <li>10 ounces ≈ ? pounds</li>
                <li>50 ounces ≈ ? pounds</li>
                <li>100 ounces ≈ ? pounds</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 ounces ≈ ? pounds</li>
                <li>1000 ounces ≈ ? pounds</li>
                <li>5000 ounces ≈ ? pounds</li>
                <li>10000 ounces ≈ ? pounds</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Ounces to Pounds</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Ounces as input and Pounds as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Ounces to Pounds conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Ounces to Pounds?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Ounces, select Ounces as input and Pounds as output, then click convert.</p>
            </div>
            <div className="card p-6">
