...
export const metadata: Metadata = {
  ...
  description: 'km/h to mph converter. Convert kilometers per hour to miles per hour instantly. 1 km/h = 0.621371 mph. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'KM/H to MPH Converter - Convert Kilometers per Hour to Miles per Hour',
    description: 'km/h to mph converter. Convert kilometers per hour to miles per hour instantly. 1 km/h = 0.621371 mph. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">KM/H to MPH Converter - Convert Kilometers per Hour to Miles per Hour</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            km/h to mph converter. Convert kilometers per hour to miles per hour instantly. 1 km/h = 0.621371 mph. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="kmh" defaultTo="mph" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Kmh to Mph conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 kmh = 310.685596119 mph</li>
                <li>1000 kmh = 621.371192237 mph</li>
                <li>5000 kmh = 3106.85596119 mph</li>
                <li>10000 kmh = 6213.71192237 mph</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Kmh to Mph</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Kmh as input and Mph as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Kmh to Mph conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Kmh to Mph?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Kmh, select Kmh as input and Mph as output, then click convert.</p>
            </div>
            <div className="card p-6">
