...
export const metadata: Metadata = {
  ...
  description: 'feet to yards converter. Convert ft to yd instantly with accurate results.',
  openGraph: {
    title: 'Feet to Yards Converter',
    description: 'feet to yards converter. Convert ft to yd instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Feet to Yards Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            feet to yards converter. Convert ft to yd instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="feet" defaultTo="yards" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Feet to Yards conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Feet to Yards</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 feet = 0.333333333333 yards</li>
                <li>10 feet = 3.33333333333 yards</li>
                <li>50 feet = 16.6666666667 yards</li>
                <li>100 feet = 33.3333333333 yards</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Yards to Feet</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 yards = 3 feet</li>
                <li>10 yards = 30 feet</li>
                <li>50 yards = 150 feet</li>
                <li>100 yards = 300 feet</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 feet = 166.666666667 yards</li>
                <li>1000 feet = 333.333333333 yards</li>
                <li>5000 feet = 1666.66666667 yards</li>
                <li>10000 feet = 3333.33333333 yards</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Feet to Yards</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Feet as input and Yards as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Feet to Yards conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Feet to Yards?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Feet, select Feet as input and Yards as output, then click convert.</p>
            </div>
            <div className="card p-6">
