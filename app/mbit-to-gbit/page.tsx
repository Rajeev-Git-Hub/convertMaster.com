...
export const metadata: Metadata = {
  title: 'Megabits to Gigabits Converter',
  description: 'megabits to gigabits converter. Convert Mb to Gb instantly with accurate results.',
  openGraph: {
    title: 'Megabits to Gigabits Converter',
    description: 'megabits to gigabits converter. Convert Mb to Gb instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Megabits to Gigabits Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            megabits to gigabits converter. Convert Mb to Gb instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mbit to Gbit conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mbit to Gbit</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mbit = 0.0009765625 gbit</li>
                <li>10 mbit = 0.009765625 gbit</li>
                <li>50 mbit = 0.048828125 gbit</li>
                <li>100 mbit = 0.09765625 gbit</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Gbit to Mbit</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 gbit = 1024 mbit</li>
                <li>10 gbit = 10240 mbit</li>
                <li>50 gbit = 51200 mbit</li>
                <li>100 gbit = 102400 mbit</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mbit = 0.48828125 gbit</li>
                <li>1000 mbit = 0.9765625 gbit</li>
                <li>5000 mbit = 4.8828125 gbit</li>
                <li>10000 mbit = 9.765625 gbit</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mbit to Gbit</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mbit as input and Gbit as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mbit to Gbit conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mbit to Gbit?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mbit, select Mbit as input and Gbit as output, then click convert.</p>
            </div>
            <div className="card p-6">
