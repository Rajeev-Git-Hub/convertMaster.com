...
export const metadata: Metadata = {
  ...
  description: 'megabytes to terabytes converter. Convert MB to TB instantly with accurate results.',
  openGraph: {
    title: 'MB to TB Converter',
    description: 'megabytes to terabytes converter. Convert MB to TB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">MB to TB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            megabytes to terabytes converter. Convert MB to TB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mb to Tb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mb to Tb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mb = 9.5367431641e-7 tb</li>
                <li>10 mb = 0.00000953674316406 tb</li>
                <li>50 mb = 0.0000476837158203 tb</li>
                <li>100 mb = 0.0000953674316406 tb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Tb to Mb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 tb = 1048576 mb</li>
                <li>10 tb = 10485760 mb</li>
                <li>50 tb = 52428800 mb</li>
                <li>100 tb = 104857600 mb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mb = 0.000476837158203 tb</li>
                <li>1000 mb = 0.000953674316406 tb</li>
                <li>5000 mb = 0.00476837158203 tb</li>
                <li>10000 mb = 0.00953674316406 tb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mb to Tb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mb as input and Tb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mb to Tb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mb to Tb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mb, select Mb as input and Tb as output, then click convert.</p>
            </div>
            <div className="card p-6">
