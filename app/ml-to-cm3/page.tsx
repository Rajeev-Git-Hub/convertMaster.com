...
export const metadata: Metadata = {
  ...
  description: 'milliliters to cubic centimeters converter. Convert mL to cm³ instantly with accurate results.',
  openGraph: {
    title: 'Milliliters to Cubic Centimeters Converter',
    description: 'milliliters to cubic centimeters converter. Convert mL to cm³ instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Milliliters to Cubic Centimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            milliliters to cubic centimeters converter. Convert mL to cm³ instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="ml" defaultTo="cm3" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Ml to Cm3 conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 ml = 500 cm3</li>
                <li>1000 ml = 1000 cm3</li>
                <li>5000 ml = 5000 cm3</li>
                <li>10000 ml = 10000 cm3</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Ml to Cm3</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Ml as input and Cm3 as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Ml to Cm3 conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Ml to Cm3?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Ml, select Ml as input and Cm3 as output, then click convert.</p>
            </div>
            <div className="card p-6">
