...
export const metadata: Metadata = {
  title: 'Gigabits to GB Converter',
  description: 'gigabits to gigabytes converter. Convert Gb to GB instantly with accurate results.',
  openGraph: {
    title: 'Gigabits to GB Converter',
    description: 'gigabits to gigabytes converter. Convert Gb to GB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Gigabits to GB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            gigabits to gigabytes converter. Convert Gb to GB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Gbit to Gb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 gbit = 62.5 gb</li>
                <li>1000 gbit = 125 gb</li>
                <li>5000 gbit = 625 gb</li>
                <li>10000 gbit = 1250 gb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Gbit to Gb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Gbit as input and Gb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Gbit to Gb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Gbit to Gb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Gbit, select Gbit as input and Gb as output, then click convert.</p>
            </div>
            <div className="card p-6">
