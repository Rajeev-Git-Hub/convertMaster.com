...
export const metadata: Metadata = {
  title: 'Square Yards to Square Kilometers Converter',
  description: 'square yards to square kilometers converter. Convert yd² to km² instantly with accurate results.',
  openGraph: {
    title: 'Square Yards to Square Kilometers Converter',
    description: 'square yards to square kilometers converter. Convert yd² to km² instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Yards to Square Kilometers Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square yards to square kilometers converter. Convert yd² to km² instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="yd2" defaultTo="km2" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Yd2 to Km2 conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 yd² = 0.000000836 km²</li>
                <li>10 yd² = 0.00000836 km²</li>
                <li>50 yd² = 0.0000418 km²</li>
                <li>100 yd² = 0.0000836 km²</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 km² = 1196000 yd²</li>
                <li>10 km² = 11960000 yd²</li>
                <li>50 km² = 59800000 yd²</li>
                <li>100 km² = 119600000 yd²</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 yd² = 0.000418 km²</li>
                <li>1000 yd² = 0.000836 km²</li>
                <li>5000 yd² = 0.00418 km²</li>
                <li>10000 yd² = 0.00836 km²</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Yd2 to Km2</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Yd2 as input and Km2 as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Yd2 to Km2 conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Yd2 to Km2?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Yd2, select Yd2 as input and Km2 as output, then click convert.</p>
            </div>
            <div className="card p-6">
