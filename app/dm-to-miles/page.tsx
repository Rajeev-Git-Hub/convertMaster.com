...
export const metadata: Metadata = {
  title: 'Decimeters to Miles Converter',
  description: 'decimeters to miles converter. Convert dm to mi instantly with accurate results.',
  openGraph: {
    title: 'Decimeters to Miles Converter',
    description: 'decimeters to miles converter. Convert dm to mi instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Decimeters to Miles Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            decimeters to miles converter. Convert dm to mi instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="dm" defaultTo="miles" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Dm to Miles conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 dm = 0.000062 miles</li>
                <li>10 dm = 0.000621 miles</li>
                <li>50 dm = 0.003107 miles</li>
                <li>100 dm = 0.006214 miles</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 miles = 16093.4 dm</li>
                <li>10 miles = 160934 dm</li>
                <li>50 miles = 804670 dm</li>
                <li>100 miles = 1609340 dm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 dm = 0.031069 miles</li>
                <li>1000 dm = 0.062137 miles</li>
                <li>5000 dm = 0.310686 miles</li>
                <li>10000 dm = 0.621371 miles</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Dm to Miles</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Dm as input and Miles as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Dm to Miles conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Dm to Miles?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Dm, select Dm as input and Miles as output, then click convert.</p>
            </div>
            <div className="card p-6">
