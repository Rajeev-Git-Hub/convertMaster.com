...
export const metadata: Metadata = {
  title: 'Millimeters to Yards Converter',
  description: 'millimeters to yards converter. Convert mm to yd instantly with accurate results.',
  openGraph: {
    title: 'Millimeters to Yards Converter',
    description: 'millimeters to yards converter. Convert mm to yd instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Millimeters to Yards Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            millimeters to yards converter. Convert mm to yd instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="mm" defaultTo="yards" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mm to Yards conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mm to Yards</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mm = 0.00109361329834 yards</li>
                <li>10 mm = 0.0109361329834 yards</li>
                <li>50 mm = 0.0546806649169 yards</li>
                <li>100 mm = 0.109361329834 yards</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Yards to Mm</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 yards = 914.4 mm</li>
                <li>10 yards = 9144 mm</li>
                <li>50 yards = 45720 mm</li>
                <li>100 yards = 91440 mm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mm = 0.546806649169 yards</li>
                <li>1000 mm = 1.09361329834 yards</li>
                <li>5000 mm = 5.46806649169 yards</li>
                <li>10000 mm = 10.9361329834 yards</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mm to Yards</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mm as input and Yards as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mm to Yards conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mm to Yards?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mm, select Mm as input and Yards as output, then click convert.</p>
            </div>
            <div className="card p-6">
