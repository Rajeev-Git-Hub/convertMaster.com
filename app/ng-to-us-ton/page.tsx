...
export const metadata: Metadata = {
  title: 'Nanograms to US Tons Converter',
  description: 'nanograms to US tons converter. Convert ng to US ton instantly with accurate results.',
  openGraph: {
    title: 'Nanograms to US Tons Converter',
    description: 'nanograms to US tons converter. Convert ng to US ton instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Nanograms to US Tons Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            nanograms to US tons converter. Convert ng to US ton instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="ng" defaultTo="us-ton" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Ng to Us-ton conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 ng = 1.1023113109e-15 us-ton</li>
                <li>10 ng = 1.1023113109e-14 us-ton</li>
                <li>50 ng = 5.5115565546e-14 us-ton</li>
                <li>100 ng = 1.1023113109e-13 us-ton</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 us-ton = 9.0718474e+14 ng</li>
                <li>10 us-ton = 9.0718474e+15 ng</li>
                <li>50 us-ton = 4.5359237e+16 ng</li>
                <li>100 us-ton = 9.0718474e+16 ng</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 ng = 5.5115565546e-13 us-ton</li>
                <li>1000 ng = 1.1023113109e-12 us-ton</li>
                <li>5000 ng = 5.5115565546e-12 us-ton</li>
                <li>10000 ng = 1.1023113109e-11 us-ton</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Ng to Us-ton</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Ng as input and Us-ton as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Ng to Us-ton conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Ng to Us-ton?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Ng, select Ng as input and Us-ton as output, then click convert.</p>
            </div>
            <div className="card p-6">
