...
export const metadata: Metadata = {
  title: 'Kilometers to Millimeters Converter',
  description: 'kilometers to millimeters converter. Convert km to mm instantly with accurate results.',
  openGraph: {
    title: 'Kilometers to Millimeters Converter',
    description: 'kilometers to millimeters converter. Convert km to mm instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Kilometers to Millimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            kilometers to millimeters converter. Convert km to mm instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="km" defaultTo="mm" />
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 km = 1000000 mm</li>
                <li>10 km = 10000000 mm</li>
                <li>50 km = 50000000 mm</li>
                <li>100 km = 100000000 mm</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mm = 0.000001 km</li>
                <li>10 mm = 0.00001 km</li>
                <li>50 mm = 0.00005 km</li>
                <li>100 mm = 0.0001 km</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 km = 500000000 mm</li>
                <li>1000 km = 1000000000 mm</li>
                <li>5000 km = 5000000000 mm</li>
                <li>10000 km = 10000000000 mm</li>
              </ul>
            </div>
          </div>
        </section>
