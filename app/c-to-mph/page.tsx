...
export const metadata: Metadata = {
  title: 'Speed of Light to Miles per Hour Converter',
  description: 'speed of light to miles per hour converter. Convert c to mph instantly with accurate results.',
  openGraph: {
    title: 'Speed of Light to Miles per Hour Converter',
    description: 'speed of light to miles per hour converter. Convert c to mph instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Speed of Light to Miles per Hour Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            speed of light to miles per hour converter. Convert c to mph instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for C to Mph conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 c = 335308314692 mph</li>
                <li>1000 c = 670616629384 mph</li>
                <li>5000 c = 3.3530831469e+12 mph</li>
                <li>10000 c = 6.7061662938e+12 mph</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert C to Mph</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose C as input and Mph as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about C to Mph conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert C to Mph?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in C, select C as input and Mph as output, then click convert.</p>
            </div>
            <div className="card p-6">
