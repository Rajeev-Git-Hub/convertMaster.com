...
export const metadata: Metadata = {
  ...
  description: 'Convert 100 degrees Celsius to Fahrenheit instantly. 100°C equals 212°F - The boiling point of water at sea level. online converter with accurate results.',
  openGraph: {
    title: '100°C to Fahrenheit Converter - Convert 100°C to °F',
    description: 'Convert 100 degrees Celsius to Fahrenheit instantly. 100°C equals 212°F - The boiling point of water at sea level. online converter with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">100°C to Fahrenheit Converter - Convert 100°C to °F</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Convert 100 degrees Celsius to Fahrenheit instantly. 100°C equals 212°F - The boiling point of water at sea level. online converter with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="temperature" defaultFrom="100-celsius" defaultTo="fahrenheit" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for 100-celsius to Fahrenheit conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert 100-celsius to Fahrenheit</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose 100-celsius as input and Fahrenheit as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about 100-celsius to Fahrenheit conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert 100-celsius to Fahrenheit?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in 100-celsius, select 100-celsius as input and Fahrenheit as output, then click convert.</p>
            </div>
            <div className="card p-6">
