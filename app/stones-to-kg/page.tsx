...
export const metadata: Metadata = {
  ...
  description: 'stones to kg converter. Convert stones to kilograms instantly. 1 stone = 6.35029 kg. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'Stones to KG Converter - Convert Stones to Kilograms',
    description: 'stones to kg converter. Convert stones to kilograms instantly. 1 stone = 6.35029 kg. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Stones to KG Converter - Convert Stones to Kilograms</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            stones to kg converter. Convert stones to kilograms instantly. 1 stone = 6.35029 kg. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="stones" defaultTo="kg" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Stones to Kg conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 stones = 3175.14659 kg</li>
                <li>1000 stones = 6350.29318 kg</li>
                <li>5000 stones = 31751.4659 kg</li>
                <li>10000 stones = 63502.9318 kg</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Stones to Kg</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Stones as input and Kg as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Stones to Kg conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Stones to Kg?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Stones, select Stones as input and Kg as output, then click convert.</p>
            </div>
            <div className="card p-6">
