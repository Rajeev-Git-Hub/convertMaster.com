...
export const metadata: Metadata = {
  ...
  description: 'centimeters to kilometers converter. Convert cm to km instantly with accurate results.',
  openGraph: {
    title: 'Centimeters to Kilometers Converter',
    description: 'centimeters to kilometers converter. Convert cm to km instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Centimeters to Kilometers Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            centimeters to kilometers converter. Convert cm to km instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="cm" defaultTo="km" />
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 cm = 0.005 km</li>
                <li>1000 cm = 0.01 km</li>
                <li>5000 cm = 0.05 km</li>
                <li>10000 cm = 0.1 km</li>
              </ul>
            </div>
          </div>
        </section>
