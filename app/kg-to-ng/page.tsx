...
export const metadata: Metadata = {
  title: 'Kilograms to Nanograms Converter',
  description: 'kilograms to nanograms converter. Convert kg to ng instantly with accurate results.',
  openGraph: {
    title: 'Kilograms to Nanograms Converter',
    description: 'kilograms to nanograms converter. Convert kg to ng instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Kilograms to Nanograms Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            kilograms to nanograms converter. Convert kg to ng instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="weight" defaultFrom="kg" defaultTo="ng" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Kg to Ng conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Kg to Ng</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 kg = 1000000000000 ng</li>
                <li>10 kg = 10000000000000 ng</li>
                <li>50 kg = 50000000000000 ng</li>
                <li>100 kg = 100000000000000 ng</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 ng = 1e-12 kg</li>
                <li>10 ng = 1e-11 kg</li>
                <li>50 ng = 5e-11 kg</li>
                <li>100 ng = 1e-10 kg</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 kg = 500000000000000 ng</li>
                <li>1000 kg = 1000000000000000 ng</li>
                <li>5000 kg = 5000000000000000 ng</li>
                <li>10000 kg = 1e+16 ng</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Kg to Ng</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Kg as input and Ng as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Kg to Ng conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Kg to Ng?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Kg, select Kg as input and Ng as output, then click convert.</p>
            </div>
            <div className="card p-6">
