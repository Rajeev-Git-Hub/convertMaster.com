...
export const metadata: Metadata = {
  title: 'Square Kilometers to Hectares Converter',
  description: 'square kilometers to hectares converter. Convert km² to ha instantly with accurate results.',
  openGraph: {
    title: 'Square Kilometers to Hectares Converter',
    description: 'square kilometers to hectares converter. Convert km² to ha instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Square Kilometers to Hectares Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            square kilometers to hectares converter. Convert km² to ha instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="km2" defaultTo="hectare" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Km2 to Hectare conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">km² to hectare</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 km² = 100 hectare</li>
                <li>10 km² = 1000 hectare</li>
                <li>50 km² = 5000 hectare</li>
                <li>100 km² = 10000 hectare</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">hectare to km²</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 hectare = 0.01 km²</li>
                <li>10 hectare = 0.1 km²</li>
                <li>50 hectare = 0.5 km²</li>
                <li>100 hectare = 1 km²</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 km² = 50000 hectare</li>
                <li>1000 km² = 100000 hectare</li>
                <li>5000 km² = 500000 hectare</li>
                <li>10000 km² = 1000000 hectare</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Km2 to Hectare</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Km2 as input and Hectare as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Km2 to Hectare conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Km2 to Hectare?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Km2, select Km2 as input and Hectare as output, then click convert.</p>
            </div>
            <div className="card p-6">
