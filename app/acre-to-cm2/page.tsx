...
export const metadata: Metadata = {
  title: 'Acres to Square Centimeters Converter',
  description: 'acres to square centimeters converter. Convert ac to cm² instantly with accurate results.',
  openGraph: {
    title: 'Acres to Square Centimeters Converter',
    description: 'acres to square centimeters converter. Convert ac to cm² instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Acres to Square Centimeters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            acres to square centimeters converter. Convert ac to cm² instantly with accurate results.. Get accurate results instantly.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 acre = 40470000 cm²</li>
                <li>10 acre = 404700000 cm²</li>
                <li>50 acre = 2023500000 cm²</li>
                <li>100 acre = 4047000000 cm²</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 cm² = 0.0000000247 acre</li>
                <li>10 cm² = 0.000000247 acre</li>
                <li>50 cm² = 0.00000124 acre</li>
                <li>100 cm² = 0.00000247 acre</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 acre = 20235000000 cm²</li>
                <li>1000 acre = 40470000000 cm²</li>
                <li>5000 acre = 202350000000 cm²</li>
                <li>10000 acre = 404700000000 cm²</li>
              </ul>
            </div>
          </div>
        </section>
