...
export const metadata: Metadata = {
  title: 'Milligrams to Micrograms Converter',
  description: 'milligrams to micrograms converter. Convert mg to μg instantly with accurate results.',
  openGraph: {
    title: 'Milligrams to Micrograms Converter',
    description: 'milligrams to micrograms converter. Convert mg to μg instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Milligrams to Micrograms Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            milligrams to micrograms converter. Convert mg to μg instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="speed" defaultFrom="mg" defaultTo="microg" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mg to Microg conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mg to Microg</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mg = 1000 microg</li>
                <li>10 mg = 10000 microg</li>
                <li>50 mg = 50000 microg</li>
                <li>100 mg = 100000 microg</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Microg to Mg</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 microg = 0.001 mg</li>
                <li>10 microg = 0.01 mg</li>
                <li>50 microg = 0.05 mg</li>
                <li>100 microg = 0.1 mg</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mg = 500000 microg</li>
                <li>1000 mg = 1000000 microg</li>
                <li>5000 mg = 5000000 microg</li>
                <li>10000 mg = 10000000 microg</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mg to Microg</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mg as input and Microg as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mg to Microg conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mg to Microg?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mg, select Mg as input and Microg as output, then click convert.</p>
            </div>
            <div className="card p-6">
