...
export const metadata: Metadata = {
  title: 'Hours to Years Converter | Time Tool',
  description: 'Convert hours to years instantly. 1 year (Julian) = 8,766 hours. online time converter with accurate results.',
  openGraph: {
    title: 'Hours to Years Converter | Time Tool',
    description: 'Convert hours to years instantly. 1 year (Julian) = 8,766 hours. online time converter with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Hours to Years Converter | Time Tool</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Convert hours to years instantly. 1 year (Julian) = 8,766 hours. online time converter with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Hour to Year conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Hour to Year</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 hour = 0.000114077116131 year</li>
                <li>10 hour = 0.00114077116131 year</li>
                <li>50 hour = 0.00570385580653 year</li>
                <li>100 hour = 0.0114077116131 year</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Year to Hour</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 year = 8766 hour</li>
                <li>10 year = 87660 hour</li>
                <li>50 year = 438300 hour</li>
                <li>100 year = 876600 hour</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 hour = 0.0570385580653 year</li>
                <li>1000 hour = 0.114077116131 year</li>
                <li>5000 hour = 0.570385580653 year</li>
                <li>10000 hour = 1.14077116131 year</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Hour to Year</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Hour as input and Year as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Understanding time measurement units</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h4 className="text-lg font-semibold text-gray-900">Second (s)</h4>
              </div>
              <p className="text-sm text-gray-600">Base unit of time</p>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="icon-box icon-box-primary" style={{ background: '#10b981' }}>
                ...
                <h4 className="text-lg font-semibold text-gray-900">Minute (min)</h4>
              </div>
              <p className="text-sm text-gray-600">60 seconds</p>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="icon-box icon-box-primary" style={{ background: '#8b5cf6' }}>
                ...
                <h4 className="text-lg font-semibold text-gray-900">Hour (hr)</h4>
              </div>
            ...
            <div className="card p-6">
              ...
              <p className="text-sm text-gray-600">Approximately 30 days</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Hour to Year conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Hour to Year?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Hour, select Hour as input and Year as output, then click convert.</p>
            </div>
            <div className="card p-6">
        ...
        <section className="text-center">
          <div className="gradient-border p-8">
            ...
            <p className="section-subtitle mb-8">
              Discover our other time conversion tools
            </p>
