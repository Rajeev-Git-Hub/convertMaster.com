...
export const metadata: Metadata = {
  ...
  description: 'MB to bytes converter. Convert megabytes to bytes instantly. 1 MB = 1,048,576 bytes. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'MB to Bytes Converter - Convert Megabytes to Bytes',
    description: 'MB to bytes converter. Convert megabytes to bytes instantly. 1 MB = 1,048,576 bytes. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">MB to Bytes Converter - Convert Megabytes to Bytes</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            MB to bytes converter. Convert megabytes to bytes instantly. 1 MB = 1,048,576 bytes. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="data" defaultFrom="mb" defaultTo="bytes" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mb to Bytes conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mb to Bytes</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mb = 1048576 bytes</li>
                <li>10 mb = 10485760 bytes</li>
                <li>50 mb = 52428800 bytes</li>
                <li>100 mb = 104857600 bytes</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Bytes to Mb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 bytes = 9.5367431641e-7 mb</li>
                <li>10 bytes = 0.00000953674316406 mb</li>
                <li>50 bytes = 0.0000476837158203 mb</li>
                <li>100 bytes = 0.0000953674316406 mb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mb = 524288000 bytes</li>
                <li>1000 mb = 1048576000 bytes</li>
                <li>5000 mb = 5242880000 bytes</li>
                <li>10000 mb = 10485760000 bytes</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mb to Bytes</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mb as input and Bytes as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mb to Bytes conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mb to Bytes?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mb, select Mb as input and Bytes as output, then click convert.</p>
            </div>
            <div className="card p-6">
