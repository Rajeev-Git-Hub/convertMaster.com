...
export const metadata: Metadata = {
  title: 'Megabits to PB Converter',
  description: 'megabits to petabytes converter. Convert Mb to PB instantly with accurate results.',
  openGraph: {
    title: 'Megabits to PB Converter',
    description: 'megabits to petabytes converter. Convert Mb to PB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Megabits to PB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            megabits to petabytes converter. Convert Mb to PB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mbit to Pb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Mbit to Pb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 mbit = 1.1641532183e-10 pb</li>
                <li>10 mbit = 1.1641532183e-9 pb</li>
                <li>50 mbit = 5.8207660913e-9 pb</li>
                <li>100 mbit = 1.1641532183e-8 pb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Pb to Mbit</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 pb = 8589934592 mbit</li>
                <li>10 pb = 85899345920 mbit</li>
                <li>50 pb = 429496729600 mbit</li>
                <li>100 pb = 858993459200 mbit</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mbit = 5.8207660913e-8 pb</li>
                <li>1000 mbit = 1.1641532183e-7 pb</li>
                <li>5000 mbit = 5.8207660913e-7 pb</li>
                <li>10000 mbit = 0.00000116415321827 pb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mbit to Pb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mbit as input and Pb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mbit to Pb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mbit to Pb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mbit, select Mbit as input and Pb as output, then click convert.</p>
            </div>
            <div className="card p-6">
