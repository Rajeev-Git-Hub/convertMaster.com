...
export const metadata: Metadata = {
  title: 'Milligrams to Nanograms Converter',
  description: 'milligrams to nanograms converter. Convert mg to ng instantly with accurate results.',
  openGraph: {
    title: 'Milligrams to Nanograms Converter',
    description: 'milligrams to nanograms converter. Convert mg to ng instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Milligrams to Nanograms Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            milligrams to nanograms converter. Convert mg to ng instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="mg" defaultTo="ng" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mg to Ng conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mg = 500000000 ng</li>
                <li>1000 mg = 1000000000 ng</li>
                <li>5000 mg = 5000000000 ng</li>
                <li>10000 mg = 10000000000 ng</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mg to Ng</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mg as input and Ng as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mg to Ng conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mg to Ng?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mg, select Mg as input and Ng as output, then click convert.</p>
            </div>
            <div className="card p-6">
