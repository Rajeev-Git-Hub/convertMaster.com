...
export const metadata: Metadata = {
  ...
  description: 'feet to meters converter. Convert feet to meters instantly. 1 foot = 0.3048 meters. Accurate results, conversion formula, and practical examples.',
  openGraph: {
    title: 'Feet to Meters Converter - Convert Feet to Meters',
    description: 'feet to meters converter. Convert feet to meters instantly. 1 foot = 0.3048 meters. Accurate results, conversion formula, and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Feet to Meters Converter - Convert Feet to Meters</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            feet to meters converter. Convert feet to meters instantly. 1 foot = 0.3048 meters. Accurate results, conversion formula, and practical examples.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="feet" defaultTo="meters" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Feet to Meters conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 feet = 0.305 meters</li>
                <li>10 feet = 3.048 meters</li>
                <li>50 feet = 15.24 meters</li>
            ...
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Meters to Feet</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 meters = 3.281 feet</li>
                <li>10 meters = 32.808 feet</li>
                <li>50 meters = 164.042 feet</li>
                <li>100 meters = 328.084 feet</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 feet = 152.4 meters</li>
                <li>1000 feet = 304.8 meters</li>
                <li>5000 feet = 1524 meters</li>
                <li>10000 feet = 3048 meters</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Feet to Meters</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Feet as input and Meters as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Feet to Meters conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Feet to Meters?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Feet, select Feet as input and Meters as output, then click convert.</p>
            </div>
            <div className="card p-6">
