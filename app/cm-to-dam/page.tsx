...
export const metadata: Metadata = {
  title: 'Centimeters to Dekameters Converter',
  description: 'centimeters to dekameters converter. Convert cm to dam instantly with accurate results.',
  openGraph: {
    title: 'Centimeters to Dekameters Converter',
    description: 'centimeters to dekameters converter. Convert cm to dam instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Centimeters to Dekameters Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            centimeters to dekameters converter. Convert cm to dam instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="cm" defaultTo="dam" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Cm to Dam conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 cm = 0.5 dam</li>
                <li>1000 cm = 1 dam</li>
                <li>5000 cm = 5 dam</li>
                <li>10000 cm = 10 dam</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Cm to Dam</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Cm as input and Dam as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Cm to Dam conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Cm to Dam?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Cm, select Cm as input and Dam as output, then click convert.</p>
            </div>
            <div className="card p-6">
