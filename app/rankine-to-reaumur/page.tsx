        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 rankine = 3.70222222222 reaumur</li>
                <li>1000 rankine = 225.924444444 reaumur</li>
                <li>5000 rankine = 2003.70222222 reaumur</li>
                <li>10000 rankine = 4225.92444444 reaumur</li>
              </ul>
            </div>
          </div>
        </section>
