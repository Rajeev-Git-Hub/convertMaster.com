...
export const metadata: Metadata = {
  title: 'Gigabits to PB Converter',
  description: 'gigabits to petabytes converter. Convert Gb to PB instantly with accurate results.',
  openGraph: {
    title: 'Gigabits to PB Converter',
    description: 'gigabits to petabytes converter. Convert Gb to PB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Gigabits to PB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            gigabits to petabytes converter. Convert Gb to PB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Gbit to Pb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Gbit to Pb</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 gbit = 1.1920928955e-7 pb</li>
                <li>10 gbit = 0.00000119209289551 pb</li>
                <li>50 gbit = 0.00000596046447754 pb</li>
                <li>100 gbit = 0.0000119209289551 pb</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Pb to Gbit</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 pb = 8388608 gbit</li>
                <li>10 pb = 83886080 gbit</li>
                <li>50 pb = 419430400 gbit</li>
                <li>100 pb = 838860800 gbit</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 gbit = 0.0000596046447754 pb</li>
                <li>1000 gbit = 0.000119209289551 pb</li>
                <li>5000 gbit = 0.000596046447754 pb</li>
                <li>10000 gbit = 0.00119209289551 pb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Gbit to Pb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Gbit as input and Pb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Gbit to Pb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Gbit to Pb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Gbit, select Gbit as input and Pb as output, then click convert.</p>
            </div>
            <div className="card p-6">
