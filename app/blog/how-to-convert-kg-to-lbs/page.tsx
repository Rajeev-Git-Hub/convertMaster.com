            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <p className="font-bold text-blue-600">1 kg</p>
                  <p className="text-gray-600">=</p>
                  <p className="font-semibold">2.20 lbs</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <p className="font-bold text-blue-600">5 kg</p>
                  <p className="text-gray-600">=</p>
                ...
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <p className="font-bold text-blue-600">50 kg</p>
                  <p className="text-gray-600">=</p>
                  <p className="font-semibold">110.23 lbs</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <p className="font-bold text-blue-600">70 kg</p>
                  <p className="text-gray-600">=</p>
                  <p className="font-semibold">154.32 lbs</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg text-center">
                  <p className="font-bold text-blue-600">100 kg</p>
                  <p className="text-gray-600">=</p>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-bold text-gray-900 mb-2">🍎 Converting Food Weights</h3>
                  <p className="text-gray-700">
                    A 1 kg bag of rice = 2.20 lbs. A 500g package of pasta = 1.10 lbs.
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-bold text-gray-900 mb-2">📦 Shipping Packages</h3>
                  <p className="text-gray-700">
                    A 2.5 kg package = 5.51 lbs. Most shipping carriers round to the nearest pound for pricing.
                  </p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-bold text-gray-900 mb-2">💪 Gym Weights</h3>
                  <p className="text-gray-700">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/blog/metric-vs-imperial-systems" className="group bg-gray-50 p-6 rounded-xl hover:shadow-lg transition-all">
              <h3 className="font-bold text-gray-900 mb-2 group-hover:text-blue-600">Metric vs Imperial Systems</h3>
              <p className="text-sm text-gray-600">Understanding different measurement systems</p>
            </Link>
            <Link href="/blog" className="group bg-gray-50 p-6 rounded-xl hover:shadow-lg transition-all">
              ...
              <p className="text-sm text-gray-600">Browse our complete blog</p>
            </Link>
          </div>
        </div>
      </section>
