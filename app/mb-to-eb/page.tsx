...
export const metadata: Metadata = {
  title: 'MB to EB Converter',
  description: 'megabytes to exabytes converter. Convert MB to EB instantly with accurate results.',
  openGraph: {
    title: 'MB to EB Converter',
    description: 'megabytes to exabytes converter. Convert MB to EB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">MB to EB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            megabytes to exabytes converter. Convert MB to EB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Mb to Eb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 mb = 4.5474735089e-10 eb</li>
                <li>1000 mb = 9.0949470177e-10 eb</li>
                <li>5000 mb = 4.5474735089e-9 eb</li>
                <li>10000 mb = 9.0949470177e-9 eb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Mb to Eb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Mb as input and Eb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Mb to Eb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Mb to Eb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Mb, select Mb as input and Eb as output, then click convert.</p>
            </div>
            <div className="card p-6">
