          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 feet = 12 inches</li>
                <li>10 feet = 120 inches</li>
                <li>50 feet = 600 inches</li>
                <li>100 feet = 1200 inches</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 feet = 6000 inches</li>
                <li>1000 feet = 12000 inches</li>
                <li>5000 feet = 60000 inches</li>
                <li>10000 feet = 120000 inches</li>
              </ul>
            </div>
          </div>
        </section>
