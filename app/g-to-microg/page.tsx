...
export const metadata: Metadata = {
  title: 'Grams to Micrograms Converter',
  description: 'grams to micrograms converter. Convert g to μg instantly with accurate results.',
  openGraph: {
    title: 'Grams to Micrograms Converter',
    description: 'grams to micrograms converter. Convert g to μg instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Grams to Micrograms Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            grams to micrograms converter. Convert g to μg instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="speed" defaultFrom="g" defaultTo="microg" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for G to Microg conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">G to Microg</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 g = 1000000 microg</li>
                <li>10 g = 10000000 microg</li>
                <li>50 g = 50000000 microg</li>
                <li>100 g = 100000000 microg</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Microg to G</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>1 microg = 0.000001 g</li>
                <li>10 microg = 0.00001 g</li>
                <li>50 microg = 0.00005 g</li>
                <li>100 microg = 0.0001 g</li>
              </ul>
            </div>
            <div className="card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 g = 500000000 microg</li>
                <li>1000 g = 1000000000 microg</li>
                <li>5000 g = 5000000000 microg</li>
                <li>10000 g = 10000000000 microg</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert G to Microg</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose G as input and Microg as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about G to Microg conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert G to Microg?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in G, select G as input and Microg as output, then click convert.</p>
            </div>
            <div className="card p-6">
