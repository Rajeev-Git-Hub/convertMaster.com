...
export const metadata: Metadata = {
  ...
  description: 'Celsius to Kelvin converter. Convert C to K instantly. Formula: K = C + 273.15. Accurate results and practical examples.',
  openGraph: {
    title: 'Celsius to Kelvin Converter - Convert C to K',
    description: 'Celsius to Kelvin converter. Convert C to K instantly. Formula: K = C + 273.15. Accurate results and practical examples.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Celsius to Kelvin Converter - Convert C to K</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Celsius to Kelvin converter. Convert C to K instantly. Formula: K = C + 273.15. Accurate results and practical examples.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Celsius to Kelvin conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Celsius to Kelvin</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Celsius as input and Kelvin as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Celsius to Kelvin conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Celsius to Kelvin?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Celsius, select Celsius as input and Kelvin as output, then click convert.</p>
            </div>
            <div className="card p-6">
