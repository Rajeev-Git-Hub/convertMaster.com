...
export const metadata: Metadata = {
  title: 'TB to Bytes Converter',
  description: 'terabytes to bytes converter. Convert TB to bytes instantly with accurate results.',
  openGraph: {
    title: 'TB to Bytes Converter',
    description: 'terabytes to bytes converter. Convert TB to bytes instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">TB to Bytes Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            terabytes to bytes converter. Convert TB to bytes instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Tb to Bytes conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 tb = 549755813888000 bytes</li>
                <li>1000 tb = 1099511627776000 bytes</li>
                <li>5000 tb = 5497558138880000 bytes</li>
                <li>10000 tb = 1.0995116278e+16 bytes</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Tb to Bytes</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Tb as input and Bytes as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Tb to Bytes conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Tb to Bytes?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Tb, select Tb as input and Bytes as output, then click convert.</p>
            </div>
            <div className="card p-6">
