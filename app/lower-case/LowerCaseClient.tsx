...
export default function LowerCaseClient() {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = 'lower-case-text.txt';
    a.click();
    ...
    <div className="space-y-6">
      <div className="bg-green-50 border-l-4 border-green-400 p-4 rounded-r-lg">
        <p className="text-sm text-green-700">
          <strong>lower case</strong> converts every letter to lowercase. Essential for URLs, email addresses, and coding.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="relative">
          ...
          <textarea
            ...
            className="w-full h-48 p-4 rounded-xl border-2 border-gray-200 bg-white text-gray-900 text-sm focus:border-green-500 focus:ring-4 focus:ring-green-500/10 transition-all resize-y placeholder:text-gray-300"
          />
          {input && (
        ...
        <div className="relative">
          <div className="flex items-center justify-between mb-2">
            <label className="text-sm font-semibold text-gray-700 flex items-center gap-2">
              ...
              Output — <span className="text-green-600">lower case</span>
            </label>
            <div className="flex gap-2">
              {output && (
                <>
                  ...
                  <button onClick={handleCopy} className={`text-xs px-3 py-1.5 rounded-lg transition-all flex items-center gap-1 ${copySuccess ? 'bg-green-100 text-green-600' : 'bg-green-50 text-green-600 hover:bg-green-100'}`}>
          ...
          <div className={`w-full h-48 p-4 rounded-xl border-2 transition-all overflow-y-auto ${output ? 'border-green-400 bg-green-50 text-gray-900' : 'border-gray-200 bg-gray-50 text-gray-400'}`}>
