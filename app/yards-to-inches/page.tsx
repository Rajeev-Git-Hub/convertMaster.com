...
export const metadata: Metadata = {
  ...
  description: 'yards to inches converter. Convert yd to in instantly with accurate results.',
  openGraph: {
    title: 'Yards to Inches Converter',
    description: 'yards to inches converter. Convert yd to in instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Yards to Inches Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            yards to inches converter. Convert yd to in instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="yards" defaultTo="inches" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Yards to Inches conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Yards to Inches</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Yards as input and Inches as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Yards to Inches conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Yards to Inches?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Yards, select Yards as input and Inches as output, then click convert.</p>
            </div>
            <div className="card p-6">
