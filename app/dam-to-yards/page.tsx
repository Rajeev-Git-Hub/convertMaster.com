...
export const metadata: Metadata = {
  title: 'Dekameters to Yards Converter',
  description: 'dekameters to yards converter. Convert dam to yd instantly with accurate results.',
  openGraph: {
    title: 'Dekameters to Yards Converter',
    description: 'dekameters to yards converter. Convert dam to yd instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">Dekameters to Yards Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            dekameters to yards converter. Convert dam to yd instantly with accurate results.. Get accurate results instantly.
          </p>
          
          <div className="max-w-2xl mx-auto mt-8">
            <ConverterCard category="length" defaultFrom="dam" defaultTo="yards" />
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Dam to Yards conversions</p>
          </div>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Dam to Yards</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Dam as input and Yards as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Dam to Yards conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Dam to Yards?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Dam, select Dam as input and Yards as output, then click convert.</p>
            </div>
            <div className="card p-6">
