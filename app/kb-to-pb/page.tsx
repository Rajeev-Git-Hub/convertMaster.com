...
export const metadata: Metadata = {
  title: 'KB to PB Converter',
  description: 'kilobytes to petabytes converter. Convert KB to PB instantly with accurate results.',
  openGraph: {
    title: 'KB to PB Converter',
    description: 'kilobytes to petabytes converter. Convert KB to PB instantly with accurate results.',
    type: 'website',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container py-16">
        ...
        <section className="text-center mb-16">
          <h1 className="hero-gradient text-4xl font-bold mb-4">KB to PB Converter</h1>
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            kilobytes to petabytes converter. Convert KB to PB instantly with accurate results.. Get accurate results instantly.
          </p>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Quick reference for Kb to Pb conversions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>500 kb = 4.5474735089e-10 pb</li>
                <li>1000 kb = 9.0949470177e-10 pb</li>
                <li>5000 kb = 4.5474735089e-9 pb</li>
                <li>10000 kb = 9.0949470177e-9 pb</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Simple steps to convert Kb to Pb</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card p-6 text-center group">
              ...
              <p className="text-sm text-gray-600">Choose Kb as input and Pb as output</p>
            </div>
            <div className="card p-6 text-center group">
        ...
        <section className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="section-subtitle">Common questions about Kb to Pb conversions</p>
          </div>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="card p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">How do I convert Kb to Pb?</h4>
              <p className="text-sm text-gray-600">Use our converter above. Enter the value in Kb, select Kb as input and Pb as output, then click convert.</p>
            </div>
            <div className="card p-6">
